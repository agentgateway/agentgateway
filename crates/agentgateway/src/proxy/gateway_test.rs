...
#[tokio::test]
async fn llm_openai() {
	let mock = body_mock(include_bytes!("../llm/tests/response/completions/basic.json")).await;
	...
	assert_llm(io, include_bytes!("../llm/tests/requests/completions/basic.json"), want).await;
}
