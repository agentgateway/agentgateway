...
```bash
SERVER_BENCH_MAX_TOKENS=128 ./k6 run bench_k6.js --duration 1m --iterations 500 --vus 8 --env scenario=generation_speed
```
...
|----------|---------|-------------|
| `SERVER_BENCH_URL` | `http://localhost:8080/api_vllm/rs/v1` | Target server URL |
| `SERVER_BENCH_MODEL_ALIAS` | `example-model` | Model name to request |
| `SERVER_BENCH_DATASET` | `/home/imfo9020/bench-k6-llm/datasets/prompts_length_128.json` | Path to JSON dataset of prompts |
