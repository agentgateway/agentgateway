...
func (PolicySpec_Ai_ActionKind) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 1}
}
...
func (PolicySpec_ExternalAuth_FailureMode) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 5, 0}
}
...
func (PolicySpec_InferenceRouting_FailureMode) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 7, 0}
}
...
func (PolicySpec_JWT_Mode) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 10, 0}
}
...
type PolicySpec_RemoteRateLimit struct {
	...
	Host          string                            `protobuf:"bytes,2,opt,name=host,proto3" json:"host,omitempty"`
	Descriptors   []*PolicySpec_RateLimitDescriptor `protobuf:"bytes,3,rep,name=descriptors,proto3" json:"descriptors,omitempty"`
	Target        *BackendReference                 `protobuf:"bytes,4,opt,name=target,proto3" json:"target,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PolicySpec_RemoteRateLimit) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *PolicySpec_RemoteRateLimit) GetDescriptors() []*PolicySpec_RateLimitDescriptor {
	if x != nil {
...
type PolicySpec_RateLimitDescriptor struct {
	state         protoimpl.MessageState                 `protogen:"open.v1"`
	Entries       []*PolicySpec_RateLimitDescriptorEntry `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`
	Type          string                                 `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"` // "requests" or "tokens"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PolicySpec_RateLimitDescriptor) Reset() {
	*x = PolicySpec_RateLimitDescriptor{}
	mi := &file_resource_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PolicySpec_RateLimitDescriptor) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PolicySpec_RateLimitDescriptor) ProtoMessage() {}

func (x *PolicySpec_RateLimitDescriptor) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[39]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PolicySpec_RateLimitDescriptor.ProtoReflect.Descriptor instead.
func (*PolicySpec_RateLimitDescriptor) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 1}
}

func (x *PolicySpec_RateLimitDescriptor) GetEntries() []*PolicySpec_RateLimitDescriptorEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *PolicySpec_RateLimitDescriptor) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
type PolicySpec_RateLimitDescriptorEntry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	Value         string                 `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *PolicySpec_RateLimitDescriptorEntry) Reset() {
	*x = PolicySpec_RateLimitDescriptorEntry{}
	mi := &file_resource_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PolicySpec_RateLimitDescriptorEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PolicySpec_RateLimitDescriptorEntry) ProtoMessage() {}

func (x *PolicySpec_RateLimitDescriptorEntry) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PolicySpec_RateLimitDescriptorEntry.ProtoReflect.Descriptor instead.
func (*PolicySpec_RateLimitDescriptorEntry) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 2}
}

func (x *PolicySpec_RateLimitDescriptorEntry) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *PolicySpec_RateLimitDescriptorEntry) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (*PolicySpec_InferenceRouting) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 7}
}
...
func (*PolicySpec_BackendTLS) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 8}
}
...
func (*PolicySpec_RBAC) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 9}
}
...
func (*PolicySpec_TransformationPolicy) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 11}
}
...
func (*PolicySpec_HeaderTransformation) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 12}
}
...
func (*PolicySpec_BodyTransformation) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 13}
}
...
func (*PolicySpec_Ai_NamedRegex) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 2}
}
...
func (*PolicySpec_Ai_RegexRule) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 3}
}
...
func (*PolicySpec_Ai_Action) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 4}
}
...
func (*PolicySpec_Ai_RegexRules) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 5}
}
...
func (*PolicySpec_Ai_Webhook) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 6}
}
...
func (*PolicySpec_Ai_Moderation) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 7}
}
...
func (*PolicySpec_Ai_RequestRejection) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 8}
}
...
func (*PolicySpec_Ai_ResponseGuard) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 9}
}
...
func (*PolicySpec_Ai_RequestGuard) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 10}
}
...
func (*PolicySpec_Ai_PromptGuard) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 4, 11}
}
...
func (*PolicySpec_TransformationPolicy_Transform) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{30, 11, 0}
}
...
const file_resource_proto_rawDesc = "" +
	...
	"\x11remote_rate_limit\x18\f \x01(\v25.agentgateway.dev.resource.PolicySpec.RemoteRateLimitH\x00R\x0fremoteRateLimit\x1a\xdf\x01\n" +
	"\x0fRemoteRateLimit\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domain\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12[\n" +
	"\vdescriptors\x18\x03 \x03(\v29.agentgateway.dev.resource.PolicySpec.RateLimitDescriptorR\vdescriptors\x12C\n" +
	"\x06target\x18\x04 \x01(\v2+.agentgateway.dev.resource.BackendReferenceR\x06target\x1a\x83\x01\n" +
	"\x13RateLimitDescriptor\x12X\n" +
	"\aentries\x18\x01 \x03(\v2>.agentgateway.dev.resource.PolicySpec.RateLimitDescriptorEntryR\aentries\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x1aB\n" +
	"\x18RateLimitDescriptorEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x1a\x86\x02\n" +
...
var file_resource_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
...
var file_resource_proto_goTypes = []any{
	...
	(PolicySpec_ExternalAuth_FailureMode)(0),     // 4: agentgateway.dev.resource.PolicySpec.ExternalAuth.FailureMode
	(PolicySpec_InferenceRouting_FailureMode)(0), // 5: agentgateway.dev.resource.PolicySpec.InferenceRouting.FailureMode
	(PolicySpec_JWT_Mode)(0),                     // 6: agentgateway.dev.resource.PolicySpec.JWT.Mode
	(MCPBackend_StatefulMode)(0),                 // 7: agentgateway.dev.resource.MCPBackend.StatefulMode
	(MCPTarget_Protocol)(0),                      // 8: agentgateway.dev.resource.MCPTarget.Protocol
	(*Resource)(nil),                             // 9: agentgateway.dev.resource.Resource
	(*Bind)(nil),                                 // 10: agentgateway.dev.resource.Bind
	(*Listener)(nil),                             // 11: agentgateway.dev.resource.Listener
	(*TLSConfig)(nil),                            // 12: agentgateway.dev.resource.TLSConfig
	(*Route)(nil),                                // 13: agentgateway.dev.resource.Route
	(*TCPRoute)(nil),                             // 14: agentgateway.dev.resource.TCPRoute
	(*TrafficPolicy)(nil),                        // 15: agentgateway.dev.resource.TrafficPolicy
	(*Retry)(nil),                                // 16: agentgateway.dev.resource.Retry
	(*BackendAuthPolicy)(nil),                    // 17: agentgateway.dev.resource.BackendAuthPolicy
	(*Passthrough)(nil),                          // 18: agentgateway.dev.resource.Passthrough
	(*Key)(nil),                                  // 19: agentgateway.dev.resource.Key
	(*Gcp)(nil),                                  // 20: agentgateway.dev.resource.Gcp
	(*Aws)(nil),                                  // 21: agentgateway.dev.resource.Aws
	(*AwsExplicitConfig)(nil),                    // 22: agentgateway.dev.resource.AwsExplicitConfig
	(*AwsImplicit)(nil),                          // 23: agentgateway.dev.resource.AwsImplicit
	(*RouteMatch)(nil),                           // 24: agentgateway.dev.resource.RouteMatch
	(*PathMatch)(nil),                            // 25: agentgateway.dev.resource.PathMatch
	(*QueryMatch)(nil),                           // 26: agentgateway.dev.resource.QueryMatch
	(*MethodMatch)(nil),                          // 27: agentgateway.dev.resource.MethodMatch
	(*HeaderMatch)(nil),                          // 28: agentgateway.dev.resource.HeaderMatch
	(*RouteFilter)(nil),                          // 29: agentgateway.dev.resource.RouteFilter
	(*CORS)(nil),                                 // 30: agentgateway.dev.resource.CORS
	(*DirectResponse)(nil),                       // 31: agentgateway.dev.resource.DirectResponse
	(*HeaderModifier)(nil),                       // 32: agentgateway.dev.resource.HeaderModifier
	(*RequestMirror)(nil),                        // 33: agentgateway.dev.resource.RequestMirror
	(*RequestRedirect)(nil),                      // 34: agentgateway.dev.resource.RequestRedirect
	(*UrlRewrite)(nil),                           // 35: agentgateway.dev.resource.UrlRewrite
	(*Header)(nil),                               // 36: agentgateway.dev.resource.Header
	(*RouteBackend)(nil),                         // 37: agentgateway.dev.resource.RouteBackend
	(*PolicyTarget)(nil),                         // 38: agentgateway.dev.resource.PolicyTarget
	(*PolicySpec)(nil),                           // 39: agentgateway.dev.resource.PolicySpec
	(*Policy)(nil),                               // 40: agentgateway.dev.resource.Policy
	(*Backend)(nil),                              // 41: agentgateway.dev.resource.Backend
	(*StaticBackend)(nil),                        // 42: agentgateway.dev.resource.StaticBackend
	(*AIBackend)(nil),                            // 43: agentgateway.dev.resource.AIBackend
	(*MCPBackend)(nil),                           // 44: agentgateway.dev.resource.MCPBackend
	(*MCPTarget)(nil),                            // 45: agentgateway.dev.resource.MCPTarget
	(*BackendReference)(nil),                     // 46: agentgateway.dev.resource.BackendReference
	(*PolicySpec_RemoteRateLimit)(nil),           // 47: agentgateway.dev.resource.PolicySpec.RemoteRateLimit
	(*PolicySpec_RateLimitDescriptor)(nil),       // 48: agentgateway.dev.resource.PolicySpec.RateLimitDescriptor
	(*PolicySpec_RateLimitDescriptorEntry)(nil),  // 49: agentgateway.dev.resource.PolicySpec.RateLimitDescriptorEntry
	(*PolicySpec_LocalRateLimit)(nil),            // 50: agentgateway.dev.resource.PolicySpec.LocalRateLimit
	(*PolicySpec_Ai)(nil),                        // 51: agentgateway.dev.resource.PolicySpec.Ai
	(*PolicySpec_ExternalAuth)(nil),              // 52: agentgateway.dev.resource.PolicySpec.ExternalAuth
	(*PolicySpec_A2A)(nil),                       // 53: agentgateway.dev.resource.PolicySpec.A2a
	(*PolicySpec_InferenceRouting)(nil),          // 54: agentgateway.dev.resource.PolicySpec.InferenceRouting
	(*PolicySpec_BackendTLS)(nil),                // 55: agentgateway.dev.resource.PolicySpec.BackendTLS
	(*PolicySpec_RBAC)(nil),                      // 56: agentgateway.dev.resource.PolicySpec.RBAC
	(*PolicySpec_JWT)(nil),                       // 57: agentgateway.dev.resource.PolicySpec.JWT
	(*PolicySpec_TransformationPolicy)(nil),      // 58: agentgateway.dev.resource.PolicySpec.TransformationPolicy
	(*PolicySpec_HeaderTransformation)(nil),      // 59: agentgateway.dev.resource.PolicySpec.HeaderTransformation
	(*PolicySpec_BodyTransformation)(nil),        // 60: agentgateway.dev.resource.PolicySpec.BodyTransformation
	(*PolicySpec_Ai_Message)(nil),                // 61: agentgateway.dev.resource.PolicySpec.Ai.Message
	(*PolicySpec_Ai_PromptEnrichment)(nil),       // 62: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment
	(*PolicySpec_Ai_NamedRegex)(nil),             // 63: agentgateway.dev.resource.PolicySpec.Ai.NamedRegex
	(*PolicySpec_Ai_RegexRule)(nil),              // 64: agentgateway.dev.resource.PolicySpec.Ai.RegexRule
	(*PolicySpec_Ai_Action)(nil),                 // 65: agentgateway.dev.resource.PolicySpec.Ai.Action
	(*PolicySpec_Ai_RegexRules)(nil),             // 66: agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	(*PolicySpec_Ai_Webhook)(nil),                // 67: agentgateway.dev.resource.PolicySpec.Ai.Webhook
	(*PolicySpec_Ai_Moderation)(nil),             // 68: agentgateway.dev.resource.PolicySpec.Ai.Moderation
	(*PolicySpec_Ai_RequestRejection)(nil),       // 69: agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	(*PolicySpec_Ai_ResponseGuard)(nil),          // 70: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard
	(*PolicySpec_Ai_RequestGuard)(nil),           // 71: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard
	(*PolicySpec_Ai_PromptGuard)(nil),            // 72: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard
	nil,                                          // 73: agentgateway.dev.resource.PolicySpec.Ai.DefaultsEntry
	nil,                                          // 74: agentgateway.dev.resource.PolicySpec.Ai.OverridesEntry
	(*PolicySpec_ExternalAuth_BodyOptions)(nil),  // 75: agentgateway.dev.resource.PolicySpec.ExternalAuth.BodyOptions
	nil, // 76: agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	(*PolicySpec_TransformationPolicy_Transform)(nil), // 77: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	(*AIBackend_Override)(nil),                        // 78: agentgateway.dev.resource.AIBackend.Override
	(*AIBackend_OpenAI)(nil),                          // 79: agentgateway.dev.resource.AIBackend.OpenAI
	(*AIBackend_Gemini)(nil),                          // 80: agentgateway.dev.resource.AIBackend.Gemini
	(*AIBackend_Vertex)(nil),                          // 81: agentgateway.dev.resource.AIBackend.Vertex
	(*AIBackend_Anthropic)(nil),                       // 82: agentgateway.dev.resource.AIBackend.Anthropic
	(*AIBackend_Bedrock)(nil),                         // 83: agentgateway.dev.resource.AIBackend.Bedrock
	(*duration.Duration)(nil),                         // 84: google.protobuf.Duration
	(*wrappers.UInt32Value)(nil),                      // 85: google.protobuf.UInt32Value
	(*wrappers.BytesValue)(nil),                       // 86: google.protobuf.BytesValue
	(*wrappers.BoolValue)(nil),                        // 87: google.protobuf.BoolValue
	(*wrappers.StringValue)(nil),                      // 88: google.protobuf.StringValue
}
var file_resource_proto_depIdxs = []int32{
	10,  // 0: agentgateway.dev.resource.Resource.bind:type_name -> agentgateway.dev.resource.Bind
	11,  // 1: agentgateway.dev.resource.Resource.listener:type_name -> agentgateway.dev.resource.Listener
	13,  // 2: agentgateway.dev.resource.Resource.route:type_name -> agentgateway.dev.resource.Route
	...
	14,  // 5: agentgateway.dev.resource.Resource.tcp_route:type_name -> agentgateway.dev.resource.TCPRoute
	0,   // 6: agentgateway.dev.resource.Listener.protocol:type_name -> agentgateway.dev.resource.Protocol
	12,  // 7: agentgateway.dev.resource.Listener.tls:type_name -> agentgateway.dev.resource.TLSConfig
	24,  // 8: agentgateway.dev.resource.Route.matches:type_name -> agentgateway.dev.resource.RouteMatch
	29,  // 9: agentgateway.dev.resource.Route.filters:type_name -> agentgateway.dev.resource.RouteFilter
	37,  // 10: agentgateway.dev.resource.Route.backends:type_name -> agentgateway.dev.resource.RouteBackend
	15,  // 11: agentgateway.dev.resource.Route.traffic_policy:type_name -> agentgateway.dev.resource.TrafficPolicy
	39,  // 12: agentgateway.dev.resource.Route.inline_policies:type_name -> agentgateway.dev.resource.PolicySpec
	37,  // 13: agentgateway.dev.resource.TCPRoute.backends:type_name -> agentgateway.dev.resource.RouteBackend
	84,  // 14: agentgateway.dev.resource.TrafficPolicy.backend_request_timeout:type_name -> google.protobuf.Duration
	84,  // 15: agentgateway.dev.resource.TrafficPolicy.request_timeout:type_name -> google.protobuf.Duration
	16,  // 16: agentgateway.dev.resource.TrafficPolicy.retry:type_name -> agentgateway.dev.resource.Retry
	84,  // 17: agentgateway.dev.resource.Retry.backoff:type_name -> google.protobuf.Duration
	18,  // 18: agentgateway.dev.resource.BackendAuthPolicy.passthrough:type_name -> agentgateway.dev.resource.Passthrough
	19,  // 19: agentgateway.dev.resource.BackendAuthPolicy.key:type_name -> agentgateway.dev.resource.Key
	20,  // 20: agentgateway.dev.resource.BackendAuthPolicy.gcp:type_name -> agentgateway.dev.resource.Gcp
	21,  // 21: agentgateway.dev.resource.BackendAuthPolicy.aws:type_name -> agentgateway.dev.resource.Aws
	22,  // 22: agentgateway.dev.resource.Aws.explicit_config:type_name -> agentgateway.dev.resource.AwsExplicitConfig
	23,  // 23: agentgateway.dev.resource.Aws.implicit:type_name -> agentgateway.dev.resource.AwsImplicit
	25,  // 24: agentgateway.dev.resource.RouteMatch.path:type_name -> agentgateway.dev.resource.PathMatch
	28,  // 25: agentgateway.dev.resource.RouteMatch.headers:type_name -> agentgateway.dev.resource.HeaderMatch
	27,  // 26: agentgateway.dev.resource.RouteMatch.method:type_name -> agentgateway.dev.resource.MethodMatch
	26,  // 27: agentgateway.dev.resource.RouteMatch.query_params:type_name -> agentgateway.dev.resource.QueryMatch
	32,  // 28: agentgateway.dev.resource.RouteFilter.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	32,  // 29: agentgateway.dev.resource.RouteFilter.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	34,  // 30: agentgateway.dev.resource.RouteFilter.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	35,  // 31: agentgateway.dev.resource.RouteFilter.url_rewrite:type_name -> agentgateway.dev.resource.UrlRewrite
	33,  // 32: agentgateway.dev.resource.RouteFilter.request_mirror:type_name -> agentgateway.dev.resource.RequestMirror
	31,  // 33: agentgateway.dev.resource.RouteFilter.direct_response:type_name -> agentgateway.dev.resource.DirectResponse
	30,  // 34: agentgateway.dev.resource.RouteFilter.cors:type_name -> agentgateway.dev.resource.CORS
	84,  // 35: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	36,  // 36: agentgateway.dev.resource.HeaderModifier.add:type_name -> agentgateway.dev.resource.Header
	36,  // 37: agentgateway.dev.resource.HeaderModifier.set:type_name -> agentgateway.dev.resource.Header
	46,  // 38: agentgateway.dev.resource.RequestMirror.backend:type_name -> agentgateway.dev.resource.BackendReference
	46,  // 39: agentgateway.dev.resource.RouteBackend.backend:type_name -> agentgateway.dev.resource.BackendReference
	29,  // 40: agentgateway.dev.resource.RouteBackend.filters:type_name -> agentgateway.dev.resource.RouteFilter
	50,  // 41: agentgateway.dev.resource.PolicySpec.local_rate_limit:type_name -> agentgateway.dev.resource.PolicySpec.LocalRateLimit
	52,  // 42: agentgateway.dev.resource.PolicySpec.ext_authz:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth
	53,  // 43: agentgateway.dev.resource.PolicySpec.a2a:type_name -> agentgateway.dev.resource.PolicySpec.A2a
	54,  // 44: agentgateway.dev.resource.PolicySpec.inference_routing:type_name -> agentgateway.dev.resource.PolicySpec.InferenceRouting
	55,  // 45: agentgateway.dev.resource.PolicySpec.backend_tls:type_name -> agentgateway.dev.resource.PolicySpec.BackendTLS
	17,  // 46: agentgateway.dev.resource.PolicySpec.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	56,  // 47: agentgateway.dev.resource.PolicySpec.authorization:type_name -> agentgateway.dev.resource.PolicySpec.RBAC
	56,  // 48: agentgateway.dev.resource.PolicySpec.mcp_authorization:type_name -> agentgateway.dev.resource.PolicySpec.RBAC
	51,  // 49: agentgateway.dev.resource.PolicySpec.ai:type_name -> agentgateway.dev.resource.PolicySpec.Ai
	57,  // 50: agentgateway.dev.resource.PolicySpec.jwt:type_name -> agentgateway.dev.resource.PolicySpec.JWT
	58,  // 51: agentgateway.dev.resource.PolicySpec.transformation:type_name -> agentgateway.dev.resource.PolicySpec.TransformationPolicy
	47,  // 52: agentgateway.dev.resource.PolicySpec.remote_rate_limit:type_name -> agentgateway.dev.resource.PolicySpec.RemoteRateLimit
	38,  // 53: agentgateway.dev.resource.Policy.target:type_name -> agentgateway.dev.resource.PolicyTarget
	39,  // 54: agentgateway.dev.resource.Policy.spec:type_name -> agentgateway.dev.resource.PolicySpec
	42,  // 55: agentgateway.dev.resource.Backend.static:type_name -> agentgateway.dev.resource.StaticBackend
	43,  // 56: agentgateway.dev.resource.Backend.ai:type_name -> agentgateway.dev.resource.AIBackend
	44,  // 57: agentgateway.dev.resource.Backend.mcp:type_name -> agentgateway.dev.resource.MCPBackend
	78,  // 58: agentgateway.dev.resource.AIBackend.override:type_name -> agentgateway.dev.resource.AIBackend.Override
	79,  // 59: agentgateway.dev.resource.AIBackend.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	80,  // 60: agentgateway.dev.resource.AIBackend.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	81,  // 61: agentgateway.dev.resource.AIBackend.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	82,  // 62: agentgateway.dev.resource.AIBackend.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	83,  // 63: agentgateway.dev.resource.AIBackend.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	45,  // 64: agentgateway.dev.resource.MCPBackend.targets:type_name -> agentgateway.dev.resource.MCPTarget
	7,   // 65: agentgateway.dev.resource.MCPBackend.stateful_mode:type_name -> agentgateway.dev.resource.MCPBackend.StatefulMode
	46,  // 66: agentgateway.dev.resource.MCPTarget.backend:type_name -> agentgateway.dev.resource.BackendReference
	8,   // 67: agentgateway.dev.resource.MCPTarget.protocol:type_name -> agentgateway.dev.resource.MCPTarget.Protocol
	48,  // 68: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.descriptors:type_name -> agentgateway.dev.resource.PolicySpec.RateLimitDescriptor
	46,  // 69: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.target:type_name -> agentgateway.dev.resource.BackendReference
	49,  // 70: agentgateway.dev.resource.PolicySpec.RateLimitDescriptor.entries:type_name -> agentgateway.dev.resource.PolicySpec.RateLimitDescriptorEntry
	84,  // 71: agentgateway.dev.resource.PolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	1,   // 72: agentgateway.dev.resource.PolicySpec.LocalRateLimit.type:type_name -> agentgateway.dev.resource.PolicySpec.LocalRateLimit.Type
	72,  // 73: agentgateway.dev.resource.PolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.PolicySpec.Ai.PromptGuard
	73,  // 74: agentgateway.dev.resource.PolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.PolicySpec.Ai.DefaultsEntry
	74,  // 75: agentgateway.dev.resource.PolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.PolicySpec.Ai.OverridesEntry
	62,  // 76: agentgateway.dev.resource.PolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment
	46,  // 77: agentgateway.dev.resource.PolicySpec.ExternalAuth.target:type_name -> agentgateway.dev.resource.BackendReference
	76,  // 78: agentgateway.dev.resource.PolicySpec.ExternalAuth.context:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	4,   // 79: agentgateway.dev.resource.PolicySpec.ExternalAuth.failure_mode:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.FailureMode
	75,  // 80: agentgateway.dev.resource.PolicySpec.ExternalAuth.include_request_body:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.BodyOptions
	84,  // 81: agentgateway.dev.resource.PolicySpec.ExternalAuth.timeout:type_name -> google.protobuf.Duration
	85,  // 82: agentgateway.dev.resource.PolicySpec.ExternalAuth.status_on_error:type_name -> google.protobuf.UInt32Value
	46,  // 83: agentgateway.dev.resource.PolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	5,   // 84: agentgateway.dev.resource.PolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.PolicySpec.InferenceRouting.FailureMode
	86,  // 85: agentgateway.dev.resource.PolicySpec.BackendTLS.cert:type_name -> google.protobuf.BytesValue
	86,  // 86: agentgateway.dev.resource.PolicySpec.BackendTLS.key:type_name -> google.protobuf.BytesValue
	86,  // 87: agentgateway.dev.resource.PolicySpec.BackendTLS.root:type_name -> google.protobuf.BytesValue
	87,  // 88: agentgateway.dev.resource.PolicySpec.BackendTLS.insecure:type_name -> google.protobuf.BoolValue
	88,  // 89: agentgateway.dev.resource.PolicySpec.BackendTLS.hostname:type_name -> google.protobuf.StringValue
	6,   // 90: agentgateway.dev.resource.PolicySpec.JWT.mode:type_name -> agentgateway.dev.resource.PolicySpec.JWT.Mode
	77,  // 91: agentgateway.dev.resource.PolicySpec.TransformationPolicy.request:type_name -> agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	77,  // 92: agentgateway.dev.resource.PolicySpec.TransformationPolicy.response:type_name -> agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	61,  // 93: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Message
	61,  // 94: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Message
	2,   // 95: agentgateway.dev.resource.PolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.PolicySpec.Ai.BuiltinRegexRule
	63,  // 96: agentgateway.dev.resource.PolicySpec.Ai.RegexRule.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.NamedRegex
	3,   // 97: agentgateway.dev.resource.PolicySpec.Ai.Action.kind:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ActionKind
	69,  // 98: agentgateway.dev.resource.PolicySpec.Ai.Action.reject_response:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	65,  // 99: agentgateway.dev.resource.PolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Action
	64,  // 100: agentgateway.dev.resource.PolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRule
	28,  // 101: agentgateway.dev.resource.PolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	88,  // 102: agentgateway.dev.resource.PolicySpec.Ai.Moderation.model:type_name -> google.protobuf.StringValue
	17,  // 103: agentgateway.dev.resource.PolicySpec.Ai.Moderation.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	66,  // 104: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	67,  // 105: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Webhook
	69,  // 106: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	66,  // 107: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	67,  // 108: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Webhook
	68,  // 109: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Moderation
	71,  // 110: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestGuard
	70,  // 111: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard
	59,  // 112: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.PolicySpec.HeaderTransformation
	59,  // 113: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.PolicySpec.HeaderTransformation
	60,  // 114: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.PolicySpec.BodyTransformation
	88,  // 115: agentgateway.dev.resource.AIBackend.OpenAI.model:type_name -> google.protobuf.StringValue
	88,  // 116: agentgateway.dev.resource.AIBackend.Gemini.model:type_name -> google.protobuf.StringValue
	88,  // 117: agentgateway.dev.resource.AIBackend.Vertex.model:type_name -> google.protobuf.StringValue
	88,  // 118: agentgateway.dev.resource.AIBackend.Anthropic.model:type_name -> google.protobuf.StringValue
	88,  // 119: agentgateway.dev.resource.AIBackend.Bedrock.model:type_name -> google.protobuf.StringValue
	88,  // 120: agentgateway.dev.resource.AIBackend.Bedrock.guardrail_identifier:type_name -> google.protobuf.StringValue
	88,  // 121: agentgateway.dev.resource.AIBackend.Bedrock.guardrail_version:type_name -> google.protobuf.StringValue
