...
|`source.certificate`|string|URL-encoded PEM of the downstream client certificate. Present only when the client presented a certificate during the TLS handshake.|
