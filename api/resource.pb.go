...
const (
	...
	MCPTarget_HTTP_TOOL       MCPTarget_Protocol = 3
)
...
type MCPTarget struct {
	...
	HttpTools     []*HttpTool            `protobuf:"bytes,5,rep,name=http_tools,json=httpTools,proto3" json:"http_tools,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MCPTarget) GetHttpTools() []*HttpTool {
	if x != nil {
		return x.HttpTools
	}
	return nil
...
// HttpTool defines a single HTTP-native MCP tool backed by a Kubernetes Service.
// The tool args are POSTed as JSON to the referenced service.
type HttpTool struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	Name        string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Description string                 `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// JSON-serialized MCP inputSchema (JSON Schema 2020-12).
...
func (x *HttpTool) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpTool) ProtoMessage() {}

func (x *HttpTool) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[55]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HttpTool.ProtoReflect.Descriptor instead.
func (*HttpTool) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{55}
}

func (x *HttpTool) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *HttpTool) GetDescription() string {
	if x != nil {
...
func (x *HttpTool) GetSchemaJson() string {
	if x != nil {
		return x.SchemaJson
	}
	return ""
...
func (x *HttpTool) GetBackend() *BackendReference {
	if x != nil {
		return x.Backend
	}
	return nil
...
func (*TrafficPolicySpec_ExtProc_NamespacedMetadataContext) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{46, 12, 2}
}
...
const file_resource_proto_rawDesc = "" +
	...
	"\bprotocol\x18\x04 \x01(\x0e2-.agentgateway.dev.resource.MCPTarget.ProtocolR\bprotocol\x12B\n" +
	"\n" +
	"http_tools\x18\x05 \x03(\v2#.agentgateway.dev.resource.HttpToolR\thttpTools\"F\n" +
	"\bProtocol\x12\r\n" +
	"\tUNDEFINED\x10\x00\x12\a\n" +
	"\x03SSE\x10\x01\x12\x13\n" +
	"\x0fSTREAMABLE_HTTP\x10\x02\x12\r\n" +
	"\tHTTP_TOOL\x10\x03\"\xa8\x01\n" +
	"\bHttpTool\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x1f\n" +
	"\vschema_json\x18\x03 \x01(\tR\n" +
	"schemaJson\x12E\n" +
	"\abackend\x18\x04 \x01(\v2+.agentgateway.dev.resource.BackendReferenceR\abackend\"\xe0\x01\n" +
...
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 151)
var file_resource_proto_goTypes = []any{
	...
	(*HttpTool)(nil),                                       // 86: agentgateway.dev.resource.HttpTool
	(*BackendReference)(nil),                               // 87: agentgateway.dev.resource.BackendReference
	(*Alpn)(nil),                                           // 88: agentgateway.dev.resource.Alpn
	(*Gcp_AccessToken)(nil),                                // 89: agentgateway.dev.resource.Gcp.AccessToken
	(*Gcp_IdToken)(nil),                                    // 90: agentgateway.dev.resource.Gcp.IdToken
	(*AzureManagedIdentityCredential_UserAssignedIdentity)(nil), // 91: agentgateway.dev.resource.AzureManagedIdentityCredential.UserAssignedIdentity
	(*RequestMirrors_Mirror)(nil),                               // 92: agentgateway.dev.resource.RequestMirrors.Mirror
	(*PolicyTarget_ServiceTarget)(nil),                          // 93: agentgateway.dev.resource.PolicyTarget.ServiceTarget
	(*PolicyTarget_BackendTarget)(nil),                          // 94: agentgateway.dev.resource.PolicyTarget.BackendTarget
	(*PolicyTarget_GatewayTarget)(nil),                          // 95: agentgateway.dev.resource.PolicyTarget.GatewayTarget
	(*PolicyTarget_RouteTarget)(nil),                            // 96: agentgateway.dev.resource.PolicyTarget.RouteTarget
	(*FrontendPolicySpec_HTTP)(nil),                             // 97: agentgateway.dev.resource.FrontendPolicySpec.HTTP
	(*FrontendPolicySpec_TLS)(nil),                              // 98: agentgateway.dev.resource.FrontendPolicySpec.TLS
	(*FrontendPolicySpec_TCP)(nil),                              // 99: agentgateway.dev.resource.FrontendPolicySpec.TCP
	(*FrontendPolicySpec_NetworkAuthorization)(nil),             // 100: agentgateway.dev.resource.FrontendPolicySpec.NetworkAuthorization
	(*FrontendPolicySpec_Logging)(nil),                          // 101: agentgateway.dev.resource.FrontendPolicySpec.Logging
	(*FrontendPolicySpec_Tracing)(nil),                          // 102: agentgateway.dev.resource.FrontendPolicySpec.Tracing
	(*FrontendPolicySpec_TracingAttribute)(nil),                 // 103: agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	(*FrontendPolicySpec_Logging_Field)(nil),                    // 104: agentgateway.dev.resource.FrontendPolicySpec.Logging.Field
	(*FrontendPolicySpec_Logging_Fields)(nil),                   // 105: agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields
	(*FrontendPolicySpec_Logging_OtlpAccessLog)(nil),            // 106: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog
	(*TrafficPolicySpec_RemoteRateLimit)(nil),                   // 107: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit
	(*TrafficPolicySpec_LocalRateLimit)(nil),                    // 108: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit
	(*TrafficPolicySpec_ExternalAuth)(nil),                      // 109: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	(*TrafficPolicySpec_RBAC)(nil),                              // 110: agentgateway.dev.resource.TrafficPolicySpec.RBAC
	(*TrafficPolicySpec_JWTProvider)(nil),                       // 111: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider
	(*TrafficPolicySpec_JWT)(nil),                               // 112: agentgateway.dev.resource.TrafficPolicySpec.JWT
	(*TrafficPolicySpec_BasicAuthentication)(nil),               // 113: agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication
	(*TrafficPolicySpec_APIKey)(nil),                            // 114: agentgateway.dev.resource.TrafficPolicySpec.APIKey
	(*TrafficPolicySpec_TransformationPolicy)(nil),              // 115: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	(*TrafficPolicySpec_HeaderTransformation)(nil),              // 116: agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	(*TrafficPolicySpec_BodyTransformation)(nil),                // 117: agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	(*TrafficPolicySpec_CSRF)(nil),                              // 118: agentgateway.dev.resource.TrafficPolicySpec.CSRF
	(*TrafficPolicySpec_ExtProc)(nil),                           // 119: agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	(*TrafficPolicySpec_HostRewrite)(nil),                       // 120: agentgateway.dev.resource.TrafficPolicySpec.HostRewrite
	(*TrafficPolicySpec_RemoteRateLimit_Descriptor)(nil),        // 121: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor
	(*TrafficPolicySpec_RemoteRateLimit_Entry)(nil),             // 122: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Entry
	(*TrafficPolicySpec_ExternalAuth_BodyOptions)(nil),          // 123: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.BodyOptions
	(*TrafficPolicySpec_ExternalAuth_GRPCProtocol)(nil),         // 124: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol
	(*TrafficPolicySpec_ExternalAuth_HTTPProtocol)(nil),         // 125: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol
	nil,                                   // 126: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.ContextEntry
	nil,                                   // 127: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.MetadataEntry
	nil,                                   // 128: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.AddRequestHeadersEntry
	nil,                                   // 129: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.MetadataEntry
	(*TrafficPolicySpec_JWT_MCP)(nil),     // 130: agentgateway.dev.resource.TrafficPolicySpec.JWT.MCP
	(*TrafficPolicySpec_APIKey_User)(nil), // 131: agentgateway.dev.resource.TrafficPolicySpec.APIKey.User
	(*TrafficPolicySpec_TransformationPolicy_Transform)(nil), // 132: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	nil, // 133: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.MetadataEntry
	...
	(*TrafficPolicySpec_ExtProc_NamespacedMetadataContext)(nil), // 136: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext
	nil,                           // 137: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry
	nil,                           // 138: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.ContextEntry
	(*BackendPolicySpec_Ai)(nil),  // 139: agentgateway.dev.resource.BackendPolicySpec.Ai
	(*BackendPolicySpec_A2A)(nil), // 140: agentgateway.dev.resource.BackendPolicySpec.A2a
	(*BackendPolicySpec_InferenceRouting)(nil),      // 141: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting
	(*BackendPolicySpec_Eviction)(nil),              // 142: agentgateway.dev.resource.BackendPolicySpec.Eviction
	(*BackendPolicySpec_Health)(nil),                // 143: agentgateway.dev.resource.BackendPolicySpec.Health
	(*BackendPolicySpec_BackendTLS)(nil),            // 144: agentgateway.dev.resource.BackendPolicySpec.BackendTLS
	(*BackendPolicySpec_BackendHTTP)(nil),           // 145: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP
	(*BackendPolicySpec_BackendTunnel)(nil),         // 146: agentgateway.dev.resource.BackendPolicySpec.BackendTunnel
	(*BackendPolicySpec_BackendTCP)(nil),            // 147: agentgateway.dev.resource.BackendPolicySpec.BackendTCP
	(*BackendPolicySpec_McpAuthorization)(nil),      // 148: agentgateway.dev.resource.BackendPolicySpec.McpAuthorization
	(*BackendPolicySpec_McpAuthentication)(nil),     // 149: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication
	(*BackendPolicySpec_Ai_Message)(nil),            // 150: agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	(*BackendPolicySpec_Ai_PromptEnrichment)(nil),   // 151: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	(*BackendPolicySpec_Ai_RegexRule)(nil),          // 152: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	(*BackendPolicySpec_Ai_RegexRules)(nil),         // 153: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	(*BackendPolicySpec_Ai_Webhook)(nil),            // 154: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	(*BackendPolicySpec_Ai_Moderation)(nil),         // 155: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	(*BackendPolicySpec_Ai_BedrockGuardrails)(nil),  // 156: agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	(*BackendPolicySpec_Ai_GoogleModelArmor)(nil),   // 157: agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	(*BackendPolicySpec_Ai_AzureContentSafety)(nil), // 158: agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety
	(*BackendPolicySpec_Ai_RequestRejection)(nil),   // 159: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	(*BackendPolicySpec_Ai_ResponseGuard)(nil),      // 160: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	(*BackendPolicySpec_Ai_RequestGuard)(nil),       // 161: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	(*BackendPolicySpec_Ai_PromptGuard)(nil),        // 162: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	(*BackendPolicySpec_Ai_PromptCaching)(nil),      // 163: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptCaching
	nil, // 164: agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	nil, // 165: agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	nil, // 166: agentgateway.dev.resource.BackendPolicySpec.Ai.TransformationsEntry
	nil, // 167: agentgateway.dev.resource.BackendPolicySpec.Ai.ModelAliasesEntry
	nil, // 168: agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry
	(*BackendPolicySpec_McpAuthentication_ResourceMetadata)(nil), // 169: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	nil,                                    // 170: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry
	(*AIBackend_HostOverride)(nil),         // 171: agentgateway.dev.resource.AIBackend.HostOverride
	(*AIBackend_OpenAI)(nil),               // 172: agentgateway.dev.resource.AIBackend.OpenAI
	(*AIBackend_Gemini)(nil),               // 173: agentgateway.dev.resource.AIBackend.Gemini
	(*AIBackend_Vertex)(nil),               // 174: agentgateway.dev.resource.AIBackend.Vertex
	(*AIBackend_Anthropic)(nil),            // 175: agentgateway.dev.resource.AIBackend.Anthropic
	(*AIBackend_Bedrock)(nil),              // 176: agentgateway.dev.resource.AIBackend.Bedrock
	(*AIBackend_AzureOpenAI)(nil),          // 177: agentgateway.dev.resource.AIBackend.AzureOpenAI
	(*AIBackend_Azure)(nil),                // 178: agentgateway.dev.resource.AIBackend.Azure
	(*AIBackend_Provider)(nil),             // 179: agentgateway.dev.resource.AIBackend.Provider
	(*AIBackend_ProviderGroup)(nil),        // 180: agentgateway.dev.resource.AIBackend.ProviderGroup
	(*BackendReference_Service)(nil),       // 181: agentgateway.dev.resource.BackendReference.Service
	(*workloadapi.Workload)(nil),           // 182: istio.workload.Workload
	(*workloadapi.Service)(nil),            // 183: istio.workload.Service
	(*workloadapi.NamespacedHostname)(nil), // 184: istio.workload.NamespacedHostname
...
var file_resource_proto_depIdxs = []int32{
	...
	182, // 6: agentgateway.dev.resource.Resource.workload:type_name -> istio.workload.Workload
	183, // 7: agentgateway.dev.resource.Resource.service:type_name -> istio.workload.Service
	...
	184, // 15: agentgateway.dev.resource.Route.service_key:type_name -> istio.workload.NamespacedHostname
	...
	184, // 20: agentgateway.dev.resource.TCPRoute.service_key:type_name -> istio.workload.NamespacedHostname
	...
	185, // 39: agentgateway.dev.resource.Timeout.request:type_name -> google.protobuf.Duration
	185, // 40: agentgateway.dev.resource.Timeout.backend_request:type_name -> google.protobuf.Duration
	185, // 41: agentgateway.dev.resource.Retry.backoff:type_name -> google.protobuf.Duration
	...
	89,  // 47: agentgateway.dev.resource.Gcp.access_token:type_name -> agentgateway.dev.resource.Gcp.AccessToken
	90,  // 48: agentgateway.dev.resource.Gcp.id_token:type_name -> agentgateway.dev.resource.Gcp.IdToken
	...
	91,  // 57: agentgateway.dev.resource.AzureManagedIdentityCredential.user_assigned_identity:type_name -> agentgateway.dev.resource.AzureManagedIdentityCredential.UserAssignedIdentity
	...
	185, // 62: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	...
	92,  // 65: agentgateway.dev.resource.RequestMirrors.mirrors:type_name -> agentgateway.dev.resource.RequestMirrors.Mirror
	87,  // 66: agentgateway.dev.resource.RouteBackend.backend:type_name -> agentgateway.dev.resource.BackendReference
	78,  // 67: agentgateway.dev.resource.RouteBackend.backend_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	95,  // 68: agentgateway.dev.resource.PolicyTarget.gateway:type_name -> agentgateway.dev.resource.PolicyTarget.GatewayTarget
	96,  // 69: agentgateway.dev.resource.PolicyTarget.route:type_name -> agentgateway.dev.resource.PolicyTarget.RouteTarget
	94,  // 70: agentgateway.dev.resource.PolicyTarget.backend:type_name -> agentgateway.dev.resource.PolicyTarget.BackendTarget
	93,  // 71: agentgateway.dev.resource.PolicyTarget.service:type_name -> agentgateway.dev.resource.PolicyTarget.ServiceTarget
	185, // 72: agentgateway.dev.resource.KeepaliveConfig.time:type_name -> google.protobuf.Duration
	185, // 73: agentgateway.dev.resource.KeepaliveConfig.interval:type_name -> google.protobuf.Duration
	99,  // 74: agentgateway.dev.resource.FrontendPolicySpec.tcp:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TCP
	98,  // 75: agentgateway.dev.resource.FrontendPolicySpec.tls:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TLS
	97,  // 76: agentgateway.dev.resource.FrontendPolicySpec.http:type_name -> agentgateway.dev.resource.FrontendPolicySpec.HTTP
	101, // 77: agentgateway.dev.resource.FrontendPolicySpec.logging:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging
	102, // 78: agentgateway.dev.resource.FrontendPolicySpec.tracing:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Tracing
	100, // 79: agentgateway.dev.resource.FrontendPolicySpec.network_authorization:type_name -> agentgateway.dev.resource.FrontendPolicySpec.NetworkAuthorization
	...
	108, // 83: agentgateway.dev.resource.TrafficPolicySpec.local_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit
	109, // 84: agentgateway.dev.resource.TrafficPolicySpec.ext_authz:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	110, // 85: agentgateway.dev.resource.TrafficPolicySpec.authorization:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RBAC
	112, // 86: agentgateway.dev.resource.TrafficPolicySpec.jwt:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT
	115, // 87: agentgateway.dev.resource.TrafficPolicySpec.transformation:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	107, // 88: agentgateway.dev.resource.TrafficPolicySpec.remote_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit
	118, // 89: agentgateway.dev.resource.TrafficPolicySpec.csrf:type_name -> agentgateway.dev.resource.TrafficPolicySpec.CSRF
	119, // 90: agentgateway.dev.resource.TrafficPolicySpec.ext_proc:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	...
	113, // 98: agentgateway.dev.resource.TrafficPolicySpec.basic_auth:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication
	114, // 99: agentgateway.dev.resource.TrafficPolicySpec.api_key_auth:type_name -> agentgateway.dev.resource.TrafficPolicySpec.APIKey
	120, // 100: agentgateway.dev.resource.TrafficPolicySpec.host_rewrite:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HostRewrite
	140, // 101: agentgateway.dev.resource.BackendPolicySpec.a2a:type_name -> agentgateway.dev.resource.BackendPolicySpec.A2a
	141, // 102: agentgateway.dev.resource.BackendPolicySpec.inference_routing:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting
	144, // 103: agentgateway.dev.resource.BackendPolicySpec.backend_tls:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS
	46,  // 104: agentgateway.dev.resource.BackendPolicySpec.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	148, // 105: agentgateway.dev.resource.BackendPolicySpec.mcp_authorization:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthorization
	149, // 106: agentgateway.dev.resource.BackendPolicySpec.mcp_authentication:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication
	139, // 107: agentgateway.dev.resource.BackendPolicySpec.ai:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai
	...
	145, // 112: agentgateway.dev.resource.BackendPolicySpec.backend_http:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendHTTP
	147, // 113: agentgateway.dev.resource.BackendPolicySpec.backend_tcp:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTCP
	115, // 114: agentgateway.dev.resource.BackendPolicySpec.transformation:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	143, // 115: agentgateway.dev.resource.BackendPolicySpec.health:type_name -> agentgateway.dev.resource.BackendPolicySpec.Health
	146, // 116: agentgateway.dev.resource.BackendPolicySpec.backend_tunnel:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTunnel
	82,  // 117: agentgateway.dev.resource.AwsBackend.agent_core:type_name -> agentgateway.dev.resource.AwsAgentCoreBackend
	180, // 118: agentgateway.dev.resource.AIBackend.provider_groups:type_name -> agentgateway.dev.resource.AIBackend.ProviderGroup
	...
	87,  // 123: agentgateway.dev.resource.MCPTarget.backend:type_name -> agentgateway.dev.resource.BackendReference
	30,  // 124: agentgateway.dev.resource.MCPTarget.protocol:type_name -> agentgateway.dev.resource.MCPTarget.Protocol
	86,  // 125: agentgateway.dev.resource.MCPTarget.http_tools:type_name -> agentgateway.dev.resource.HttpTool
	87,  // 126: agentgateway.dev.resource.HttpTool.backend:type_name -> agentgateway.dev.resource.BackendReference
	181, // 127: agentgateway.dev.resource.BackendReference.service:type_name -> agentgateway.dev.resource.BackendReference.Service
	87,  // 128: agentgateway.dev.resource.RequestMirrors.Mirror.backend:type_name -> agentgateway.dev.resource.BackendReference
	185, // 129: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http1_idle_timeout:type_name -> google.protobuf.Duration
	185, // 130: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http2_keepalive_interval:type_name -> google.protobuf.Duration
	185, // 131: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http2_keepalive_timeout:type_name -> google.protobuf.Duration
	185, // 132: agentgateway.dev.resource.FrontendPolicySpec.TLS.handshake_timeout:type_name -> google.protobuf.Duration
	88,  // 133: agentgateway.dev.resource.FrontendPolicySpec.TLS.alpn:type_name -> agentgateway.dev.resource.Alpn
	5,   // 134: agentgateway.dev.resource.FrontendPolicySpec.TLS.cipher_suites:type_name -> agentgateway.dev.resource.TLSConfig.CipherSuite
	3,   // 135: agentgateway.dev.resource.FrontendPolicySpec.TLS.min_version:type_name -> agentgateway.dev.resource.TLSConfig.TLSVersion
	3,   // 136: agentgateway.dev.resource.FrontendPolicySpec.TLS.max_version:type_name -> agentgateway.dev.resource.TLSConfig.TLSVersion
	74,  // 137: agentgateway.dev.resource.FrontendPolicySpec.TCP.keepalives:type_name -> agentgateway.dev.resource.KeepaliveConfig
	105, // 138: agentgateway.dev.resource.FrontendPolicySpec.Logging.fields:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields
	106, // 139: agentgateway.dev.resource.FrontendPolicySpec.Logging.otlp_access_log:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog
	87,  // 140: agentgateway.dev.resource.FrontendPolicySpec.Tracing.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	103, // 141: agentgateway.dev.resource.FrontendPolicySpec.Tracing.attributes:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	103, // 142: agentgateway.dev.resource.FrontendPolicySpec.Tracing.resources:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	7,   // 143: agentgateway.dev.resource.FrontendPolicySpec.Tracing.protocol:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Tracing.Protocol
	104, // 144: agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields.add:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.Field
	87,  // 145: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	78,  // 146: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	6,   // 147: agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog.protocol:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.OtlpAccessLog.Protocol
	121, // 148: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.descriptors:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor
	87,  // 149: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.target:type_name -> agentgateway.dev.resource.BackendReference
	10,  // 150: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.failure_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.FailureMode
	185, // 151: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	11,  // 152: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.type:type_name -> agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.Type
	87,  // 153: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.target:type_name -> agentgateway.dev.resource.BackendReference
	124, // 154: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.grpc:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol
	125, // 155: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.http:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol
	12,  // 156: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.failure_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.FailureMode
	123, // 157: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.include_request_body:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.BodyOptions
	76,  // 158: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.jwt_validation_options:type_name -> agentgateway.dev.resource.JWTValidationOptions
	13,  // 159: agentgateway.dev.resource.TrafficPolicySpec.JWT.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT.Mode
	111, // 160: agentgateway.dev.resource.TrafficPolicySpec.JWT.providers:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWTProvider
	130, // 161: agentgateway.dev.resource.TrafficPolicySpec.JWT.mcp:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT.MCP
	14,  // 162: agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication.Mode
	131, // 163: agentgateway.dev.resource.TrafficPolicySpec.APIKey.api_keys:type_name -> agentgateway.dev.resource.TrafficPolicySpec.APIKey.User
	15,  // 164: agentgateway.dev.resource.TrafficPolicySpec.APIKey.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.APIKey.Mode
	132, // 165: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.request:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	132, // 166: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.response:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	87,  // 167: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.target:type_name -> agentgateway.dev.resource.BackendReference
	16,  // 168: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.failure_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.FailureMode
	134, // 169: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.request_attributes:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.RequestAttributesEntry
	135, // 170: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.response_attributes:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ResponseAttributesEntry
	137, // 171: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.metadata_context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry
	17,  // 172: agentgateway.dev.resource.TrafficPolicySpec.HostRewrite.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HostRewrite.Mode
	122, // 173: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.entries:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Entry
	9,   // 174: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.type:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Type
	126, // 175: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.ContextEntry
	127, // 176: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.MetadataEntry
	128, // 177: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.add_request_headers:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.AddRequestHeadersEntry
	129, // 178: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.MetadataEntry
	24,  // 179: agentgateway.dev.resource.TrafficPolicySpec.JWT.MCP.provider:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.McpIDP
	169, // 180: agentgateway.dev.resource.TrafficPolicySpec.JWT.MCP.resource_metadata:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	186, // 181: agentgateway.dev.resource.TrafficPolicySpec.APIKey.User.metadata:type_name -> google.protobuf.Struct
	116, // 182: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	116, // 183: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	117, // 184: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	133, // 185: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.MetadataEntry
	138, // 186: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.ContextEntry
	136, // 187: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry.value:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext
	162, // 188: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	164, // 189: agentgateway.dev.resource.BackendPolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	165, // 190: agentgateway.dev.resource.BackendPolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	166, // 191: agentgateway.dev.resource.BackendPolicySpec.Ai.transformations:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.TransformationsEntry
	151, // 192: agentgateway.dev.resource.BackendPolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	167, // 193: agentgateway.dev.resource.BackendPolicySpec.Ai.model_aliases:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ModelAliasesEntry
	163, // 194: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_caching:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptCaching
	168, // 195: agentgateway.dev.resource.BackendPolicySpec.Ai.routes:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry
	87,  // 196: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	21,  // 197: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.FailureMode
	185, // 198: agentgateway.dev.resource.BackendPolicySpec.Eviction.duration:type_name -> google.protobuf.Duration
	142, // 199: agentgateway.dev.resource.BackendPolicySpec.Health.eviction:type_name -> agentgateway.dev.resource.BackendPolicySpec.Eviction
	22,  // 200: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.verification:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS.VerificationMode
	88,  // 201: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.alpn:type_name -> agentgateway.dev.resource.Alpn
	23,  // 202: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.version:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.HttpVersion
	185, // 203: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.request_timeout:type_name -> google.protobuf.Duration
	87,  // 204: agentgateway.dev.resource.BackendPolicySpec.BackendTunnel.proxy:type_name -> agentgateway.dev.resource.BackendReference
	74,  // 205: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.keepalive:type_name -> agentgateway.dev.resource.KeepaliveConfig
	185, // 206: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.connect_timeout:type_name -> google.protobuf.Duration
	24,  // 207: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.provider:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.McpIDP
	169, // 208: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.resource_metadata:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	25,  // 209: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.Mode
	76,  // 210: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.jwt_validation_options:type_name -> agentgateway.dev.resource.JWTValidationOptions
	150, // 211: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	150, // 212: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	18,  // 213: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BuiltinRegexRule
	19,  // 214: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ActionKind
	152, // 215: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	87,  // 216: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.backend:type_name -> agentgateway.dev.resource.BackendReference
	64,  // 217: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	78,  // 218: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	78,  // 219: agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	78,  // 220: agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	78,  // 221: agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	159, // 222: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	153, // 223: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	154, // 224: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	157, // 225: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	156, // 226: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	158, // 227: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.azure_content_safety:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety
	159, // 228: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	153, // 229: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	154, // 230: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	155, // 231: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	157, // 232: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	156, // 233: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	158, // 234: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.azure_content_safety:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.AzureContentSafety
	161, // 235: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	160, // 236: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	20,  // 237: agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry.value:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RouteType
	170, // 238: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.extra:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry
	187, // 239: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry.value:type_name -> google.protobuf.Value
	26,  // 240: agentgateway.dev.resource.AIBackend.Azure.resource_type:type_name -> agentgateway.dev.resource.AIBackend.AzureResourceType
	171, // 241: agentgateway.dev.resource.AIBackend.Provider.host_override:type_name -> agentgateway.dev.resource.AIBackend.HostOverride
	172, // 242: agentgateway.dev.resource.AIBackend.Provider.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	173, // 243: agentgateway.dev.resource.AIBackend.Provider.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	174, // 244: agentgateway.dev.resource.AIBackend.Provider.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	175, // 245: agentgateway.dev.resource.AIBackend.Provider.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	176, // 246: agentgateway.dev.resource.AIBackend.Provider.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	177, // 247: agentgateway.dev.resource.AIBackend.Provider.azureopenai:type_name -> agentgateway.dev.resource.AIBackend.AzureOpenAI
	178, // 248: agentgateway.dev.resource.AIBackend.Provider.azure:type_name -> agentgateway.dev.resource.AIBackend.Azure
	78,  // 249: agentgateway.dev.resource.AIBackend.Provider.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	179, // 250: agentgateway.dev.resource.AIBackend.ProviderGroup.providers:type_name -> agentgateway.dev.resource.AIBackend.Provider
