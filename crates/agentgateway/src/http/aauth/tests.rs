...
fn hwk_jwk_for(public_key: &crate::http::aauth::sig::keys::ed25519::PublicKey) -> Jwk {
	Jwk {
		kty: "OKP".to_string(),
...
fn required_scheme_ordering() {
	use crate::http::aauth::sig::signing::SignatureScheme;
