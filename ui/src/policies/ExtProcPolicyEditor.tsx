	...
	if (unsupportedTarget) {
		return (
			<UnsupportedYamlFallback
				...
				help={props.help}
			>
				{tr('copy.unsupportedTargetDescription', [unsupportedTargetLabel(props.extProc)])}
			</UnsupportedYamlFallback>
		);
	}
	...
	return (
		...
		>
			...
			<PolicySection
				...
				description={tr('copy.chooseFailureBehaviorAndWhichRequestResponsePhasesAreSent')}
			>
				<FieldGroup
