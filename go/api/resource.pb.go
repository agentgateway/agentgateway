...
func (x *PolicySpec_ExtProc) GetFailureModeAllow() bool {
	if x != nil {
...
const file_resource_proto_rawDesc = "" +
	...
	"expression\x1a5\n" +
	"\x04CSRF\x12-\n" +
	"\x12additional_origins\x18\x01 \x03(\tR\x11additionalOrigins\x1a|\n" +
	"\aExtProc\x12C\n" +
	"\x06target\x18\x01 \x01(\v2+.agentgateway.dev.resource.BackendReferenceR\x06target\x12,\n" +
	"\x12failure_mode_allow\x18\x02 \x01(\bR\x10failureModeAllowB\x06\n" +
	"\x04kind\"\x98\x01\n" +
	"\x06Policy\x12\x12\n" +
...
var file_resource_proto_goTypes = []any{
	...
	(*PolicySpec_ExtProc)(nil),                                  // 69: agentgateway.dev.resource.PolicySpec.ExtProc
	(*PolicySpec_RemoteRateLimit_Descriptor)(nil),               // 70: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor
	(*PolicySpec_RemoteRateLimit_Entry)(nil),                    // 71: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Entry
	(*PolicySpec_Ai_Message)(nil),                               // 72: agentgateway.dev.resource.PolicySpec.Ai.Message
	(*PolicySpec_Ai_PromptEnrichment)(nil),                      // 73: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment
	(*PolicySpec_Ai_NamedRegex)(nil),                            // 74: agentgateway.dev.resource.PolicySpec.Ai.NamedRegex
	(*PolicySpec_Ai_RegexRule)(nil),                             // 75: agentgateway.dev.resource.PolicySpec.Ai.RegexRule
	(*PolicySpec_Ai_Action)(nil),                                // 76: agentgateway.dev.resource.PolicySpec.Ai.Action
	(*PolicySpec_Ai_RegexRules)(nil),                            // 77: agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	(*PolicySpec_Ai_Webhook)(nil),                               // 78: agentgateway.dev.resource.PolicySpec.Ai.Webhook
	(*PolicySpec_Ai_Moderation)(nil),                            // 79: agentgateway.dev.resource.PolicySpec.Ai.Moderation
	(*PolicySpec_Ai_RequestRejection)(nil),                      // 80: agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	(*PolicySpec_Ai_ResponseGuard)(nil),                         // 81: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard
	(*PolicySpec_Ai_RequestGuard)(nil),                          // 82: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard
	(*PolicySpec_Ai_PromptGuard)(nil),                           // 83: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard
	nil,                                                         // 84: agentgateway.dev.resource.PolicySpec.Ai.DefaultsEntry
	nil,                                                         // 85: agentgateway.dev.resource.PolicySpec.Ai.OverridesEntry
	nil,                                                         // 86: agentgateway.dev.resource.PolicySpec.Ai.ModelAliasesEntry
	(*PolicySpec_ExternalAuth_BodyOptions)(nil),                 // 87: agentgateway.dev.resource.PolicySpec.ExternalAuth.BodyOptions
	nil, // 88: agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	(*PolicySpec_TransformationPolicy_Transform)(nil), // 89: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	(*AIBackend_HostOverride)(nil),                    // 90: agentgateway.dev.resource.AIBackend.HostOverride
	(*AIBackend_OpenAI)(nil),                          // 91: agentgateway.dev.resource.AIBackend.OpenAI
	(*AIBackend_Gemini)(nil),                          // 92: agentgateway.dev.resource.AIBackend.Gemini
	(*AIBackend_Vertex)(nil),                          // 93: agentgateway.dev.resource.AIBackend.Vertex
	(*AIBackend_Anthropic)(nil),                       // 94: agentgateway.dev.resource.AIBackend.Anthropic
	(*AIBackend_Bedrock)(nil),                         // 95: agentgateway.dev.resource.AIBackend.Bedrock
	(*AIBackend_Provider)(nil),                        // 96: agentgateway.dev.resource.AIBackend.Provider
	(*AIBackend_ProviderGroup)(nil),                   // 97: agentgateway.dev.resource.AIBackend.ProviderGroup
	nil,                                               // 98: agentgateway.dev.resource.AIBackend.Provider.RoutesEntry
...
var file_resource_proto_depIdxs = []int32{
	...
	69,  // 61: agentgateway.dev.resource.PolicySpec.ext_proc:type_name -> agentgateway.dev.resource.PolicySpec.ExtProc
	...
	97,  // 67: agentgateway.dev.resource.AIBackend.provider_groups:type_name -> agentgateway.dev.resource.AIBackend.ProviderGroup
	...
	70,  // 72: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.descriptors:type_name -> agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor
	54,  // 73: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.target:type_name -> agentgateway.dev.resource.BackendReference
	99,  // 74: agentgateway.dev.resource.PolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	...
	83,  // 76: agentgateway.dev.resource.PolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.PolicySpec.Ai.PromptGuard
	84,  // 77: agentgateway.dev.resource.PolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.PolicySpec.Ai.DefaultsEntry
	85,  // 78: agentgateway.dev.resource.PolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.PolicySpec.Ai.OverridesEntry
	73,  // 79: agentgateway.dev.resource.PolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment
	86,  // 80: agentgateway.dev.resource.PolicySpec.Ai.model_aliases:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ModelAliasesEntry
	54,  // 81: agentgateway.dev.resource.PolicySpec.ExternalAuth.target:type_name -> agentgateway.dev.resource.BackendReference
	88,  // 82: agentgateway.dev.resource.PolicySpec.ExternalAuth.context:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	...
	87,  // 84: agentgateway.dev.resource.PolicySpec.ExternalAuth.include_request_body:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.BodyOptions
	99,  // 85: agentgateway.dev.resource.PolicySpec.ExternalAuth.timeout:type_name -> google.protobuf.Duration
	...
	89,  // 95: agentgateway.dev.resource.PolicySpec.TransformationPolicy.request:type_name -> agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	89,  // 96: agentgateway.dev.resource.PolicySpec.TransformationPolicy.response:type_name -> agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	54,  // 97: agentgateway.dev.resource.PolicySpec.ExtProc.target:type_name -> agentgateway.dev.resource.BackendReference
	71,  // 98: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor.entries:type_name -> agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Entry
	1,   // 99: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor.type:type_name -> agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Type
	72,  // 100: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Message
	72,  // 101: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Message
	3,   // 102: agentgateway.dev.resource.PolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.PolicySpec.Ai.BuiltinRegexRule
	74,  // 103: agentgateway.dev.resource.PolicySpec.Ai.RegexRule.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.NamedRegex
	4,   // 104: agentgateway.dev.resource.PolicySpec.Ai.Action.kind:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ActionKind
	80,  // 105: agentgateway.dev.resource.PolicySpec.Ai.Action.reject_response:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	76,  // 106: agentgateway.dev.resource.PolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Action
	75,  // 107: agentgateway.dev.resource.PolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRule
	36,  // 108: agentgateway.dev.resource.PolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	103, // 109: agentgateway.dev.resource.PolicySpec.Ai.Moderation.model:type_name -> google.protobuf.StringValue
	19,  // 110: agentgateway.dev.resource.PolicySpec.Ai.Moderation.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	77,  // 111: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	78,  // 112: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Webhook
	80,  // 113: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	77,  // 114: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	78,  // 115: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Webhook
	79,  // 116: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Moderation
	82,  // 117: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestGuard
	81,  // 118: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard
	66,  // 119: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.PolicySpec.HeaderTransformation
	66,  // 120: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.PolicySpec.HeaderTransformation
	67,  // 121: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.PolicySpec.BodyTransformation
	103, // 122: agentgateway.dev.resource.AIBackend.OpenAI.model:type_name -> google.protobuf.StringValue
	103, // 123: agentgateway.dev.resource.AIBackend.Gemini.model:type_name -> google.protobuf.StringValue
	103, // 124: agentgateway.dev.resource.AIBackend.Vertex.model:type_name -> google.protobuf.StringValue
	103, // 125: agentgateway.dev.resource.AIBackend.Anthropic.model:type_name -> google.protobuf.StringValue
	...
	90,  // 129: agentgateway.dev.resource.AIBackend.Provider.host_override:type_name -> agentgateway.dev.resource.AIBackend.HostOverride
	103, // 130: agentgateway.dev.resource.AIBackend.Provider.path_override:type_name -> google.protobuf.StringValue
	91,  // 131: agentgateway.dev.resource.AIBackend.Provider.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	92,  // 132: agentgateway.dev.resource.AIBackend.Provider.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	93,  // 133: agentgateway.dev.resource.AIBackend.Provider.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	94,  // 134: agentgateway.dev.resource.AIBackend.Provider.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	95,  // 135: agentgateway.dev.resource.AIBackend.Provider.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	98,  // 136: agentgateway.dev.resource.AIBackend.Provider.routes:type_name -> agentgateway.dev.resource.AIBackend.Provider.RoutesEntry
	96,  // 137: agentgateway.dev.resource.AIBackend.ProviderGroup.providers:type_name -> agentgateway.dev.resource.AIBackend.Provider
	8,   // 138: agentgateway.dev.resource.AIBackend.Provider.RoutesEntry.value:type_name -> agentgateway.dev.resource.AIBackend.RouteType
