...
// MarshalJSON is a custom marshaler for BackendPolicySpec_Ai_ContextCompression
func (this *BackendPolicySpec_Ai_ContextCompression) MarshalJSON() ([]byte, error) {
	str, err := ResourceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for BackendPolicySpec_Ai_ContextCompression
func (this *BackendPolicySpec_Ai_ContextCompression) UnmarshalJSON(b []byte) error {
	return ResourceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
