...
export function ProviderIcon(props: { provider: ProviderName | string; size?: number }) {
  ...
  return (
    <img
      className={monochromeProviders.has(props.provider) ? "provider-icon provider-icon-mono" : "provider-icon"}
      src={icon}
      alt=""
      aria-hidden="true"
    />
