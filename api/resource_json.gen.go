...
// MarshalJSON is a custom marshaler for BackendPolicySpec_ExtMcp_Remote
func (this *BackendPolicySpec_ExtMcp_Remote) MarshalJSON() ([]byte, error) {
	str, err := ResourceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for BackendPolicySpec_ExtMcp_Remote
func (this *BackendPolicySpec_ExtMcp_Remote) UnmarshalJSON(b []byte) error {
	return ResourceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}

// MarshalJSON is a custom marshaler for BackendPolicySpec_ExtMcp_Processor
func (this *BackendPolicySpec_ExtMcp_Processor) MarshalJSON() ([]byte, error) {
	str, err := ResourceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for BackendPolicySpec_ExtMcp_Processor
func (this *BackendPolicySpec_ExtMcp_Processor) UnmarshalJSON(b []byte) error {
	return ResourceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
