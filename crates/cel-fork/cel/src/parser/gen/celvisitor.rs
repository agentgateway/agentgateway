...
pub trait CELVisitor<'input>: ParseTreeVisitor<'input, CELParserContextType> {
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_Match(&mut self, ctx: &MatchContext<'input>) {
		self.visit_children(ctx)
	}
	...
	/**
	 * Visit a parse tree produced by {@link CELParser#matchArmList}.
	 * @param ctx the parse tree
	 */
	fn visit_matchArmList(&mut self, ctx: &MatchArmListContext<'input>) {
		self.visit_children(ctx)
	}

	/**
	 * Visit a parse tree produced by {@link CELParser#matchArm}.
	 * @param ctx the parse tree
	 */
	fn visit_matchArm(&mut self, ctx: &MatchArmContext<'input>) {
		self.visit_children(ctx)
	}
	...
	ParseTreeVisitorCompat<'input, Node = CELParserContextType>
{
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_Match(&mut self, ctx: &MatchContext<'input>) -> Self::Return {
		self.visit_children(ctx)
	}
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_matchArmList(&mut self, ctx: &MatchArmListContext<'input>) -> Self::Return {
		self.visit_children(ctx)
	}
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_matchArm(&mut self, ctx: &MatchArmContext<'input>) -> Self::Return {
		self.visit_children(ctx)
	}
	...
	T: CELVisitorCompat<'input>,
{
	...
	fn visit_Match(&mut self, ctx: &MatchContext<'input>) {
		let result = <Self as CELVisitorCompat>::visit_Match(self, ctx);
		*<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_matchArmList(&mut self, ctx: &MatchArmListContext<'input>) {
		let result = <Self as CELVisitorCompat>::visit_matchArmList(self, ctx);
		*<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_matchArm(&mut self, ctx: &MatchArmContext<'input>) {
		let result = <Self as CELVisitorCompat>::visit_matchArm(self, ctx);
		*<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
