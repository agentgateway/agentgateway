...
|`binds[].listeners[].routes[].backends[].(1)ai.(any)provider.(1)azure`||
|`binds[].listeners[].routes[].backends[].(1)ai.(any)provider.(1)azure.model`||
...
|`binds[].listeners[].routes[].backends[].(1)ai.(any)groups[].providers[].provider.(1)azure`||
|`binds[].listeners[].routes[].backends[].(1)ai.(any)groups[].providers[].provider.(1)azure.model`||
