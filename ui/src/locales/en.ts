const en = {
	translation: {
		common: {
			...
			noMatchesCustomValues: 'No matches. Custom values are allowed.',
		...
		drawer: {
			...
			unsavedChangesMessage: 'Your changes have not been saved and will be lost.'
		},
		schema: {
			array: 'array',
			help: 'Help',
		...
		copy: {
			...
			backendAuthCannotBeEmpty: 'Backend auth cannot be empty.',
			backendAuthYaml: 'Backend auth YAML',
			...
			chooseWhereTheCredentialIsReadFromOrWrittenTo:
			...
			anotherGatewayIsAlreadyTheDefaultGateway: 'Another gateway is already the default gateway.',
			apiKeyAuthenticationIsDisabled: 'API key authentication is disabled',
			apiKeyPolicyConfigDiff: 'API key policy config diff',
			baseCatalog: 'Base catalog',
			baseCostsAreStoredInValueFileWritesAreDisabledInHybridMode:
				'Base costs are stored in {{value}}. File writes are disabled in hybrid mode.',
			blankFinalConditionMeansFallback: 'A blank final condition makes this the fallback',
			byDefaultCallersSendAuthorizationBearerKey:
				'By default, callers send Authorization: Bearer key.',
			cannotEnterCustomModelNamesSet: 'cannot enter custom model names; set',
			chooseAUniqueGatewayName: 'Choose a unique gateway name.',
			configurationDatabaseUnavailable: 'Configuration database unavailable',
			configureProviders: 'Configure Providers',
			corsUpdateFailed: 'CORS update failed',
			createVirtualKey: 'Create virtual key',
			customInlineOverlay: 'Custom inline overlay',
			customOverrides: 'Custom overrides',
			customExpression: 'custom expression',
			defaultUnhealthyDetectionConfigured: 'Default unhealthy detection configured',
			customizeWhereVirtualApiKeysAreReadFromTheRequest:
				'Customize where virtual API keys are read from the request.',
			defaultGateway: 'Default gateway',
			defaultNameIsReserved: 'Default name is reserved',
			defaultsConfigured: 'Defaults configured',
			deleteDatabaseResource: 'Delete database resource',
			deleteDatabaseResourceQuestion: 'Delete database resource?',
			deleteDatabaseResourceValue:
				'Delete database resource {{value}}/{{value}}? This cannot be undone.',
			deleteFailed: 'Delete failed',
			deleteResource: 'Delete resource',
			disabledFieldsAreManagedByTheFileConfigurationOtherMcpSettingsCanStillBeSavedToTheDatabase:
				'Disabled fields are managed by the file configuration. Other MCP settings can still be saved to the database.',
			editMcpServer: 'Edit MCP server',
			editVirtualKey: 'Edit virtual key',
			editVirtualModel: 'Edit virtual model',
			enableApiKeyAuth: 'Enable API key auth',
			enableApiKeyAuthentication: 'Enable API key authentication',
			enableApiKeyAuthenticationBeforeProvisioningVirtualKeys:
				'Enable API key authentication before provisioning virtual keys.',
			failedToLoadAnalytics: 'Failed to load analytics',
			failedToLoadLogDetail: 'Failed to load log detail',
			failedToLoadLogs: 'Failed to load logs',
			failedToRefreshBaseCostCatalog: 'Failed to refresh base cost catalog',
			failedToSaveCustomCosts: 'Failed to save custom costs',
			fallback: 'Fallback',
			fallbackGroupValue: 'Fallback group {{value}}',
			...
			fileOwnedGatewaysCannotBeDeletedHere: 'File-owned gateways cannot be deleted here',
			fileOwnedGatewaysMustBeEditedInRawConfiguration:
				'File-owned gateways must be edited in raw configuration',
			fileOwnedKeysCannotBeDeletedHere: 'File-owned keys cannot be deleted here',
			fileOwnedListenersCannotBeDeletedHere: 'File-owned listeners cannot be deleted here',
			fileOwnedListenersMustBeEditedInRawConfiguration:
				'File-owned listeners must be edited in raw configuration',
			fileOwnedModelsCannotBeDeletedHere: 'File-owned models cannot be deleted here',
			fileOwnedServersCannotBeDeletedHere: 'File-owned servers cannot be deleted here',
			finalTransformation: 'Final transformation',
			firstAttempt: 'First attempt',
			forModelsMissingFromTheProviderList: 'for models missing from the provider list.',
			gatewayConfigDiff: 'Gateway config diff',
			gatewayListenerConfigDiff: 'Gateway listener config diff',
			gatewayNameAlreadyExists: 'Gateway name already exists',
			hideJson: 'Hide JSON',
			inline: 'Inline',
			inspectConfigurationResourcesStoredInTheDatabase:
				'Inspect configuration resources stored in the database.',
			invalidConfigurationYaml: 'Invalid configuration YAML',
			invalidPolicyConfiguration: 'Invalid policy configuration',
			invalidRateValueUseANonNegativeDecimalWithUpTo6DecimalPlaces:
				'Invalid rate "{{value}}". Use a non-negative decimal with up to 6 decimal places.',
			invalidServerConfiguration: 'Invalid server configuration',
			keepExisting: 'Keep existing',
			loadingDatabaseResources: 'Loading database resources',
			logSettingsConfigDiff: 'Log settings config diff',
			logStreamFailed: 'Log stream failed',
			mcpServerConfigDiff: 'MCP server config diff',
			mcpSettingsConfigDiff: 'MCP settings config diff',
			modelConfigDiff: 'Model config diff',
			modelIsRequiredForEveryCustomCostRow: 'Model is required for every custom cost row.',
			modelResourceDiff: 'Model resource diff',
			noAuthorizationRulesConfigured: 'No authorization rules configured',
			noDatabaseResources: 'No database resources',
			noDefaultsConfigured: 'No defaults configured',
			noDiff: 'No diff',
			noEnabledTraffic: 'no enabled traffic',
			noFieldsConfigured: 'No fields configured',
			noModelPoliciesConfigured: 'No model policies configured',
			noModelSelected: 'No model selected',
			noOverridesConfigured: 'No overrides configured',
			orExportTheVariablesBelowBeforeStartingASession:
				', or export the variables below before starting a session.',
			...
			overridesConfigured: 'Overrides configured',
			...
			providerIsRequiredForEveryCustomCostRow: 'Provider is required for every custom cost row.',
			providerRequestFields: 'Provider request fields',
			...
			saveVirtualModel: 'Save virtual model',
			selectDefaultGatewayToUseTheNameValue: 'Select Default gateway to use the name {{value}}.',
			someSettingsAreFileOwned: 'Some settings are file-owned',
			...
			thisWillMakeTheGatewayTheDefaultGatewayAndImpactValueTraffic:
				'This will make the gateway the default gateway. This will impact {{value}} traffic.',
			toPersistTheSettingsAddThemTo: 'To persist the settings, add them to',
			unavailableWhileGatewayTlsOrPoliciesAreConfigured:
			...
			valueFieldsConfigured: '{{value}} fields configured',
			valueMessages_one: '{{count}} message',
			valueMessages_other: '{{count}} messages',
			valueNeedsAtLeastOneRate: '{{value}}/{{value}} needs at least one rate.',
			valueRecentCalls: '{{value}} recent calls',
			valueRulesConfigured_one: '{{count}} rule configured',
			valueRulesConfigured_other: '{{count}} rules configured',
			viewJson: 'View JSON',
			virtualApiKeyConfigDiff: 'Virtual API key config diff',
			virtualApiKeyResourceDiff: 'Virtual API key resource diff',
			virtualModelConfigDiff: 'Virtual model config diff',
			virtualModelResourceDiff: 'Virtual model resource diff',
			deletePolicyFromThisConfiguration: 'Delete the {{value}} policy from this configuration?',
			...
			header: 'Header',
			in: 'In',
			loadingCostConfiguration: 'Loading cost configuration',
			loadingLlmConfiguration: 'Loading LLM configuration',
			loadingPolicies: 'Loading policies',
			locationType: 'Location type',
			overrideWhereThisPolicyReadsTheCredential: 'Override where this policy reads the credential.',
			overrideWhereTheValidatedCredentialIsSent: 'Override where the validated credential is sent.',
			out: 'Out',
			passthrough: 'Passthrough',
			policyIsNotEnabled: 'Policy is not enabled',
			prompt: 'Prompt',
			promptCachingConfigured: 'Prompt caching configured',
			queryParameter: 'Query parameter',
			queryParameterName: 'Query parameter name',
			rawYaml: 'Raw YAML',
			reportedTotal: 'Reported total',
			selectHowTheGatewayAuthenticatesToTheBackend:
				'Select how the gateway authenticates to the backend.',
			showAllValueCharacters: 'Show all ({{value}} chars)',
			speed: 'Speed',
			status: 'Status',
			storage: 'Storage',
			system: 'System',
			...
			trafficCanNoLongerBeSentToThisTarget: '? Traffic can no longer be sent to this target.',
			trafficMatchingThisRouteWillNoLongerReachItsBackends:
				'? Traffic matching this route will no longer reach its backends.',
			considerMovingListenerOwnershipTo: '. Consider moving listener ownership to',
			...
			noResponseHeaderChangesConfigured: 'No response header changes configured',
			requestHeaderChangesConfigured_one: '{{count}} request header change configured',
			requestHeaderChangesConfigured_other: '{{count}} request header changes configured',
			responseHeaderChangesConfigured_one: '{{count}} response header change configured',
			responseHeaderChangesConfigured_other: '{{count}} response header changes configured',
			valueBinds_one: '{{count}} bind',
			valueBinds_other: '{{count}} binds',
			valueByValue: '{{value}} by {{value}}',
			valueConfiguredServers_one: '{{count}} configured server',
			valueConfiguredServers_other: '{{count}} configured servers',
			valueEnabled: '{{value}} enabled',
			valueGateways_one: '{{count}} gateway',
			valueGateways_other: '{{count}} gateways',
			valueListenerValueMixHttpAndTcpRoutes: '{{value}} listener{{value}} mix HTTP and TCP routes',
			valueListeners_one: '{{count}} listener',
			valueListeners_other: '{{count}} listeners',
			valueModels_one: '{{count}} model',
			valueModels_other: '{{count}} models',
			valueOf3Enabled: '{{value}} of 3 enabled',
			valuePathOverride: '{{value}} path override',
			valuePolicies_one: '{{count}} policy',
			valuePolicies_other: '{{count}} policies',
			valuePrioritiesValueTargets: '{{value}} priorities, {{value}} targets',
			valueQuickKeys: '{{value}} quick keys',
			valueRoutes_one: '{{count}} route',
			valueRoutes_other: '{{count}} routes',
			valueRows_one: '{{count}} row',
			valueRows_other: '{{count}} rows',
			valueRules_one: '{{count}} rule',
			valueRules_other: '{{count}} rules',
			valueRulesWithFallback_one: '{{count}} rule, fallback',
			valueRulesWithFallback_other: '{{count}} rules, fallback',
			valueSharedProviders_one: '{{count}} shared provider',
			valueSharedProviders_other: '{{count}} shared providers',
			valueTokensValueCalls: '{{value}} tokens / {{value}} calls',
			valueTotal: '{{value}} total',
			valueVirtualModels_one: '{{count}} virtual model',
			valueVirtualModels_other: '{{count}} virtual models',
			valueWarningValue_one: '{{count}} warning',
			valueWarningValue_other: '{{count}} warnings',
			valueWeightedTargets_one: '{{count}} weighted target',
			valueWeightedTargets_other: '{{count}} weighted targets',
			...
			privateKeyJwtClientAssertionRfc7523: '`privateKeyJwt` client assertion (RFC 7523).',
			...
			text200Ok: '200 OK',
			text400BadRequest: '400 Bad request',
			text401Unauthorized: '401 Unauthorized',
			text403Forbidden: '403 Forbidden',
			text404NotFound: '404 Not found',
			text429RateLimited: '429 Rate limited',
			text500ServerError: '500 Server error',
			...
			aSourceOfModelCostCatalogData: 'A source of model cost catalog data.',
			...
			acceptProxyProtocolV1OrV2: 'Accept PROXY protocol v1 or v2.',
			acceptProxyProtocolV1: 'Accept PROXY protocol v1.',
			acceptProxyProtocolV2: 'Accept PROXY protocol v2.',
			...
			access: 'Access',
			accessLogFieldNamesToRemove: 'Access log field names to remove.',
			accessLogFieldsToAddComputedFromCelExpressions:
				'Access log fields to add, computed from CEL expressions.',
			action: 'Action',
			actionToTakeWhenARegexRuleMatches: 'Action to take when a regex rule matches.',
			actions: 'Actions',
			activeRuntimeResourcesFromTheGatewayDump: 'Active runtime resources from the gateway dump.',
			adc: 'ADC',
			...
			addAGatewayBeforeAttachingRoutes: 'Add a gateway before attaching routes.',
			addAGatewayBeforeExposingTheUi: 'Add a gateway before exposing the UI.',
			addAGatewayBeforeHttpTrafficCanBeServed: 'Add a gateway before HTTP traffic can be served.',
			...
			addAModelBeforeLlmTrafficCanBeServed: 'Add a model before LLM traffic can be served.',
			addANameBeforeCreatingThisVirtualApiKey: 'Add a name before creating this virtual API key.',
			...
			addAProviderWhenMultipleModelsShouldShareTheSameCredentialsOrUpstreamConnectionSettings:
				'Add a provider when multiple models should share the same credentials or upstream connection settings.',
			...
			addATargetSoTheGatewayCanExposeMcpTraffic:
				'Add a target so the gateway can expose MCP traffic.',
			addAnMcpTargetBeforeToolsAreAvailable: 'Add an MCP target before tools are available.',
			...
			addCurrentOrigin: 'Add current origin',
			addDescriptor: 'Add descriptor',
			addEntry: 'Add entry',
			addFallback: 'Add fallback',
			addFallbackGroup: 'Add fallback group',
			...
			addMatch: 'Add match',
			addModel: 'Add model',
			addModelCost: 'Add model cost',
			addModelUsingProvider: 'Add model using provider',
			...
			addsGenAiPromptAndGenAiCompletionAttributesToAccessLogs:
				'Adds `gen_ai.prompt` and `gen_ai.completion` attributes to access logs.',
			...
			agentgatewayHome: 'agentgateway home',
			agentgatewayIsAGatewayThatCanRouteSecureAndObserveLlmMcpAndTraditionalApiTraffic_sbsjep:
				'Agentgateway is a gateway that can route, secure, and observe LLM, MCP, and traditional API traffic. Select one or more capabilities to enable, then continue.',
			...
			agwSkAutoGenerate: 'agw_sk_***** (auto generate)',
			ai: 'AI',
			all: 'ALL',
			allValue: 'All {{value}}',
			allow: 'Allow',
			allowAllRequestHeaders: 'Allow all request headers',
			allowCredentials: 'Allow credentials',
			allowModeOverride: 'Allow mode override',
			allowPartialMessage: 'Allow partial message',
			...
			allowTrafficWhenTheProcessorIsUnavailable: 'Allow traffic when the processor is unavailable.',
			...
			alpnProtocolsToOfferToTheBackend: 'ALPN protocols to offer to the backend.',
			always: 'Always',
			...
			analytics: 'Analytics',
			analyticsApiError: 'Analytics API error',
			analyzeApiVersion: 'Analyze API version',
			analyzeLlmTrafficByModelUserAndProvider: 'Analyze LLM traffic by model, user, and provider.',
			...
			andForwardTheModelAsIs: 'and forward the model as-is.',
			andHasNo: 'and has no',
			andSave: 'and save.',
			andSearchFor: 'and search for',
			andSendTo: 'and send to',
			andSetItTo: 'and set it to',
			andSetTheAdvancedProxyUrl: 'and set the advanced proxy URL.',
			andStripThe: 'and strip the',
			anotherVirtualKeyAlreadyUsesThisNameTheKeyWillStillBeCreatedWithAUniqueMetadataId:
				'Another virtual key already uses this name. The key will still be created with a unique metadata id.',
			anthropicV1Messages: 'Anthropic /v1/messages',
			anthropicV1MessagesCountTokens: 'Anthropic /v1/messages/count_tokens',
			anyStatus: 'Any status',
			apiKey: 'API key',
			apiKeyValueToAccept: 'API key value to accept.',
			apiKeys: 'API keys',
			apiKeysThatAreAcceptedByThisPolicy: 'API keys that are accepted by this policy.',
			apiVersionToUseDefault20240215Preview: 'API version to use (default: "2024-02-15-preview")',
			apiVersionToUseDefault20240901: 'API version to use (default: "2024-09-01")',
			apis: 'APIs',
			apply: 'Apply',
			applyAuthorization: 'Apply authorization',
			applyChanges: 'Apply changes',
			applyCors: 'Apply CORS',
			applyMcpCors: 'Apply MCP CORS',
			...
			applyRegexBasedMaskingOrRejectionRules: 'Apply regex-based masking or rejection rules.',
			arguments: 'Arguments',
			argumentsJson: 'Arguments JSON',
			argumentsMustBeAJsonObject: 'Arguments must be a JSON object.',
			asACustomModelThenTestFrom: 'as a custom model, then test from',
			ask: 'Ask',
			askATestQuestion: 'Ask a test question...',
			...
			attachARouteToAGateway: 'Attach a route to a gateway.',
			attachHttpAndTcpRoutesToTrafficGateways: 'Attach HTTP and TCP routes to traffic gateways.',
			...
			authenticateIncomingRequestsWithApiKeys: 'Authenticate incoming requests with API keys.',
			...
			authenticateMcpClients: 'Authenticate MCP clients.',
			authenticateToAzureServices: 'Authenticate to Azure services.',
			authenticateToGitHubCopilot: 'Authenticate to GitHub Copilot.',
			authenticateToGoogleCloudServices: 'Authenticate to Google Cloud services.',
			authentication: 'Authentication',
			authenticationCredentialsSentToTheBackend: 'Authentication credentials sent to the backend.',
			authenticationCredentialsSentToThisBackend:
				'Authentication credentials sent to this backend.',
			authorization: 'Authorization',
			authorizationBehavior: 'Authorization behavior',
			...
			authorizationRulesForIncomingHttpRequests: 'Authorization rules for incoming HTTP requests.',
			authorizationRulesForMcpRequests: 'Authorization rules for MCP requests.',
			...
			awsIamRoleArnToAssume: 'AWS IAM role ARN to assume.',
			awsRegion: 'AWS region',
			awsRegionWhereTheGuardrailIsDeployed: 'AWS region where the guardrail is deployed',
			...
			azureProjectName: 'Azure project name',
			azureResourceName: 'Azure resource name',
			azureResourceType: 'Azure resource type',
			backToHome: 'Back to home',
			backend: 'Backend',
			backendHostUrlForGuardrailChecks: 'Backend host URL for guardrail checks.',
			backendPolicies: 'Backend policies',
			...
			backendPoliciesPreserved: 'Backend policies preserved',
			...
			backendThatReceivesMirroredRequestCopies: 'Backend that receives mirrored request copies.',
			backendYaml: 'Backend YAML',
			backends: 'backends',
			backends_i9thuc: 'Backends',
			...
			baseCostCatalogRefreshedValueModelsFromValueProviders:
				'Base cost catalog refreshed: {{value}} models from {{value}} providers.',
			baseUrl: 'Base URL',
			...
			bind: 'Bind',
			bindPort: 'Bind port',
			bindPortThisListenerIsAttachedTo: 'Bind port this listener is attached to.',
			bindThisSurfaceOnItsOwnListenerPort: 'Bind this surface on its own listener port.',
			...
			blocklistNamesToCheckAgainst: 'Blocklist names to check against',
			blocklists: 'Blocklists',
			bodyExpression: 'Body expression',
			bodyOptions: 'Body options',
			breakdown: 'Breakdown',
			browserAccessIsNotAllowed: 'Browser access is not allowed',
			...
			bufferRequestAndResponseBodies: 'Buffer request and response bodies.',
			...
			builtInDetectors: 'Built-in detectors',
			builtInPatternName: 'Built-in pattern name.',
			caSin: 'CA SIN',
			...
			callAWebhookToEvaluateThePrompt: 'Call a webhook to evaluate the prompt.',
			callAWebhookToEvaluateTheResponse: 'Call a webhook to evaluate the response.',
			callAnHttpAuthorizationService: 'Call an HTTP authorization service.',
			callTheAuthorizationServiceUsingHttp: 'Call the authorization service using HTTP.',
			...
			callTool: 'Call tool',
			callingValueMcpValue: 'Calling {{value}} MCP {{value}}',
			calls: 'Calls',
			canBeAWildcard: 'Can be a wildcard',
			canadianSocialInsuranceNumberPattern: 'Canadian Social Insurance Number pattern.',
			cancel: 'Cancel',
			...
			celExpressionThatComputesAReplacementBody: 'CEL expression that computes a replacement body.',
			...
			celExpressionThatComputesTheResponseBody: 'CEL expression that computes the response body.',
			...
			chooseHowLlmTrafficIsExposed: 'Choose how LLM traffic is exposed.',
			chooseHowMcpIsExposed: 'Choose how MCP is exposed.',
			...
			cipherSuitesAllowedForDownstreamTls: 'Cipher suites allowed for downstream TLS.',
			...
			claudeSubscriptionKeyDetected: 'Claude subscription key detected',
			clear: 'Clear',
			clearAuthorization: 'Clear authorization',
			clearEnvironment: 'Clear environment',
			...
			close: 'Close',
			codexCli: 'Codex CLI',
			cohereV2RerankDocumentReranking: 'Cohere /v2/rerank (document reranking)',
			...
			configDumpUnavailable: 'Config dump unavailable',
			configuration: 'Configuration',
			configurationApiUnavailable: 'Configuration API unavailable',
			...
			configurationForDynamicTracingPolicy: 'Configuration for dynamic tracing policy',
			configurationForGoogleCloudModelArmorIntegration:
				'Configuration for Google Cloud Model Armor integration.',
			configurationForStatefulSessionManagement: 'Configuration for stateful session management',
			configurationForTheAnalyzeTextApi: 'Configuration for the Analyze Text API.',
			configurationForTheDetectJailbreakApi: 'Configuration for the Detect Jailbreak API.',
			...
			configurationMustBeAYamlObject: 'Configuration must be a YAML object.',
			configurationSaved: 'Configuration saved',
			configurationValidationFailedValue: 'Configuration validation failed: {{value}}',
			configureAModelFirst: 'Configure a model first',
			...
			configureMcpTargetsServedByTheGateway: 'Configure MCP targets served by the gateway.',
			...
			configureThirdPartyInference: 'Configure Third-Party Inference',
			...
			configureUiPolicies: 'Configure UI policies',
			...
			continue: 'Continue',
			continueToValue: 'Continue to {{value}}',
			...
			cookieNameContainingTheCredential: 'Cookie name containing the credential.',
			copy: 'Copy',
			copyKey: 'Copy key',
			copyToClipboard: 'Copy to clipboard',
			cost: 'Cost',
			costCatalogRefreshFailed: 'Cost catalog refresh failed',
			...
			costRefreshFailed: 'Cost refresh failed',
			costs: 'Costs',
			countEachRequestAsOneUnit: 'Count each request as one unit.',
			countLlmTokenUsage: 'Count LLM token usage.',
			...
			createAModelBeforeTestingChatTraffic: 'Create a model before testing chat traffic.',
			createAnLlmModelBeforeWiringClientsToTheGateway:
				'Create an LLM model before wiring clients to the gateway.',
			createAnMcpServerBeforeTestingMcpTraffic: 'Create an MCP server before testing MCP traffic.',
			...
			creditCardNumberPattern: 'Credit card number pattern.',
			csv: 'CSV',
			currentPolicyYaml: 'Current policy YAML',
			currentTopLevelPolicyYaml: 'Current top-level policy YAML',
			cursorSettings: 'Cursor Settings',
			custom: 'Custom',
			customAuthDetected: 'Custom auth detected',
			...
			customHeaderLocation: 'Custom header location',
			customProvider: 'Custom provider',
			customRegex: 'Custom regex',
			customRegexPatterns: 'Custom regex patterns',
			...
			databaseSpecificAccessLogSettings: 'Database-specific access log settings.',
			...
			defaultRequestValues: 'Default request values',
			defaultAuthorizationBearerToken: 'Default: Authorization: Bearer token',
			...
			delayBetweenRetryAttempts: 'Delay between retry attempts.',
			delete: 'Delete',
			deleteValue: 'Delete {{value}}',
			deleteValue_pkbukw: 'Delete {{value}}?',
			deleteBind: 'Delete bind',
			...
			deleteProvider_1j44lo: 'Delete provider?',
			deleteRoute: 'Delete route',
			deleteRoute_akv0fs: 'Delete route?',
			deleteServer: 'Delete server',
			deleteVirtualApiKey: 'Delete virtual API key?',
			deny: 'Deny',
			...
			denyWithStatus: 'Deny with status',
			...
			detectJailbreakAttempts: 'Detect jailbreak attempts',
			...
			detectedLegacyBindsConfig: 'Detected legacy binds config',
			detectingConfigurationMode: 'Detecting configuration mode',
			detectingTrafficConfigurationMode: 'Detecting traffic configuration mode',
			developer: 'Developer',
			disable: 'Disable',
			disableApiKeyPolicy: 'Disable API key policy',
			disableApiKeyPolicy_ckgvai: 'Disable API Key Policy',
			disableApiKeyPolicy_9229n3: 'Disable API key policy?',
			disableVirtualApiKeyValidationRequestsWillNoLongerBeValidatedAgainstVirtualApiKeys:
				'Disable virtual API key validation? Requests will no longer be validated against virtual API keys.',
			disabled: 'disabled',
			discardChanges: 'Discard changes',
			discardUnsavedChanges: 'Discard unsaved changes?',
			discovery: 'Discovery',
			discoveryOverride: 'Discovery override',
			...
			doNotExposeTheUiOnATrafficGateway: 'Do not expose the UI on a traffic gateway.',
			...
			doNotRunThisProcessorForMatchingMethods: 'Do not run this processor for matching methods.',
			...
			doNotSendTheBodyToTheProcessor: 'Do not send the body to the processor.',
			doNotSendThisPhaseToTheExternalProcessor: 'Do not send this phase to the external processor.',
			...
			edit: 'Edit',
			editValueGuard: 'Edit {{value}} guard',
			evictValue: 'evict {{value}}',
			editBind: 'Edit bind',
			...
			editTheFullGatewayYaml: 'Edit the full gateway YAML.',
			...
			email: 'Email',
			emailAddressPattern: 'Email address pattern.',
			enable: 'Enable',
			...
			enabled: 'enabled',
			enabled_17fi4vy: 'Enabled',
			encodeHttp1HeaderNamesInLowercase: 'Encode HTTP/1 header names in lowercase.',
			endpoint: 'Endpoint',
			...
			entries: 'Entries',
			envVar: 'Env var',
			environmentMustBeAYamlMapping: 'Environment must be a YAML mapping.',
			...
			everyListedHeaderConditionMustMatch: 'Every listed header condition must match.',
			everyListedQueryConditionMustMatch: 'Every listed query condition must match.',
			evictionDuration: 'Eviction duration',
			exampleComExampleCom: 'example.com, *.example.com',
			expectedAYamlMapping: 'Expected a YAML mapping.',
			...
			explicitEndpoints: 'Explicit endpoints',
			explicitOutgoingModel: 'Explicit outgoing model',
			export: 'Export',
			...
			externalAuthz: 'External authz',
			externalMcpPolicyProcessors: 'External MCP policy processors.',
			externalProcessor: 'External processor',
			externalServiceTheGatewayCallsForThisPolicy:
			...
			failoverTargets: 'Failover targets',
			failureMode: 'Failure mode',
			featuresAndRoutesReferenceThisGatewayByName:
				'Features and routes reference this gateway by name.',
			feedback: 'Feedback',
			fetchAnAccessToken: 'Fetch an access token',
			fetchAnIdToken: 'Fetch an id token',
			fetchSigningKeysFromTheIssuerJwksEndpoint:
				'Fetch signing keys from the issuer JWKS endpoint.',
			fetchingRecentLlmCalls: 'Fetching recent LLM calls.',
			file: 'File',
			fillInterval: 'Fill interval',
			fixTheHighlightedFieldsBeforeSaving: 'Fix the highlighted fields before saving.',
			fixTheHighlightedProcessorsBeforeSaving: 'Fix the highlighted processors before saving.',
			forAzureTheApiVersionToUse: 'For Azure: the API version to use',
			...
			forAzureTheResourceNameOfTheDeployment: 'For Azure: the resource name of the deployment',
			...
			from: 'From',
			fromTheSameDirectory: 'from the same directory.',
			...
			full: 'Full',
			fullDuplexStreamed: 'Full duplex streamed',
			fullyQuitAndRelaunchClaudeDesktopANew: 'Fully quit and relaunch Claude Desktop. A new',
			gateway: 'Gateway',
			...
			gatewaySurfaces: 'Gateway surfaces',
			...
			generateConnectionSettingsAndSnippetsForOpenAiCompatibleLlmClients:
				'Generate connection settings and snippets for OpenAI-compatible LLM clients.',
			generatedModelConfig: 'Generated model config',
			generatedProviderConfig: 'Generated provider config',
			generatedVirtualModelConfig: 'Generated virtual model config',
			getStarted: 'Get started',
			...
			group_sf1daa: 'group:',
			groups: 'Groups',
			gRpcDetails: 'gRPC details',
			guardType: 'Guard type',
			guardThisTakesEffectImmediately: 'guard? This takes effect immediately.',
			guardrailIdentifier: 'Guardrail identifier',
			guardrailVersion: 'Guardrail version',
			guardrails: 'Guardrails',
			guardrailsToApplyToEveryConfiguredModel: 'Guardrails to apply to every configured model.',
			guardrailsToApplyToTheRequestOrResponse: 'guardrails to apply to the request or response',
			...
			haltOnBlocklistHit: 'Halt on blocklist hit',
			...
			headerAllowlist: 'Header allowlist',
			headerCasingBehaviorForHttp1Responses: 'Header casing behavior for HTTP/1 responses.',
			headerLocation: 'Header location',
			headerName: 'header name',
			headerName_8vzq77: 'Header name',
			headerNameContainingTheCredential: 'Header name containing the credential.',
			headerNamesToRemove: 'Header names to remove.',
			...
			headersToSetUsingCelExpressionsForValues: 'Headers to set using CEL expressions for values.',
			headersToSetReplacingAnyExistingValues: 'Headers to set, replacing any existing values.',
			health: 'Health',
			...
			howLongAnIdleHttp1ConnectionMayStayOpen: 'How long an idle HTTP/1 connection may stay open.',
			howLongToEvictAnUnhealthyBackend: 'How long to evict an unhealthy backend.',
			howOftenTheLocalBucketIsRefilled: 'How often the local bucket is refilled.',
			...
			howTheGatewayConnectsToThisMcpTarget: 'How the gateway connects to this MCP target.',
			...
			httpAndTcpListenersRoutesAndPolicyControls:
				'HTTP and TCP listeners, routes, and policy controls.',
			httpDetails: 'HTTP details',
			httpProtocolSettingsForThisBackend: 'HTTP protocol settings for this backend.',
			...
			httpStatusCodeToReturnForTheRedirect: 'HTTP status code to return for the redirect.',
			httpStatusCodeToReturn: 'HTTP status code to return.',
			httpVersionToUseWhenConnectingToTheBackend:
				'HTTP version to use when connecting to the backend.',
			httpProxy: 'Http: Proxy',
			http2ConnectionFlowControlWindowSize: 'HTTP/2 connection flow-control window size.',
			http2StreamFlowControlWindowSize: 'HTTP/2 stream flow-control window size.',
			...
			inYourProjectRoot: 'in your project root.',
			includeMcpTools: 'Include MCP tools (',
			includeMcpToolsValueServers_one: 'Include MCP tools ({{count}} server)',
			includeMcpToolsValueServers_other: 'Include MCP tools ({{count}} servers)',
			includePromptsAndCompletionsInLogs: 'Include prompts and completions in logs',
			includeRequestBody: 'Include request body',
			includeRequestHeaders: 'Include request headers',
			includeResponseHeaders: 'Include response headers',
			incomingModel: 'Incoming model',
			incomingModelMatch: 'Incoming model match',
			...
			initializingMcpTools: 'Initializing MCP tools',
			inlineJson: 'Inline JSON',
			inlineJwks: 'Inline JWKS',
			...
			interval: 'Interval',
			intervalBetweenHttp2KeepalivePings: 'Interval between HTTP/2 keepalive pings.',
			invalidAuthorizationPolicy: 'Invalid authorization policy',
			invalidCustomCosts: 'Invalid custom costs',
			invalidGuardrails: 'Invalid guardrails',
			invalidJson: 'Invalid JSON',
			invalidJwtPolicy: 'Invalid JWT policy',
			invalidMcpAuthenticationPolicy: 'Invalid MCP authentication policy',
			invalidMcpGuardrailsPolicy: 'Invalid MCP guardrails policy',
			invalidModelPolicies: 'Invalid model policies',
			invalidOidcPolicy: 'Invalid OIDC policy',
			invalidServer: 'Invalid server',
			invalidYaml: 'Invalid YAML',
			issuer: 'Issuer',
			issuerUsedForDiscoveryAndIdTokenValidation:
				'Issuer used for discovery and ID token validation.',
			jailbreakApiVersion: 'Jailbreak API version',
			...
			jwksSourceUsedToValidateReturnedIdTokens: 'JWKS source used to validate returned ID tokens.',
			jwksUrl: 'JWKS URL',
			jwtAuth: 'JWT auth',
			...
			key: 'Key',
			keyExchangeGroupsAllowedForNegotiatingTls: 'Key exchange groups allowed for negotiating TLS.',
			keyValue: 'Key value',
			kind: 'Kind',
			last1Hour: 'Last 1 hour',
			last12Hours: 'Last 12 hours',
			...
			leaveTheAuthorityUnchanged: 'Leave the authority unchanged.',
			letTheModelCallToolsExposedByTheMcpGateway:
				'Let the model call tools exposed by the MCP gateway.',
			limitByRequestCount: 'Limit by request count.',
			limitByTokenCount: 'Limit by token count.',
			...
			listener: 'Listener',
			listenerPolicies: 'Listener policies',
			listenerThatOwnsThisRoute: 'Listener that owns this route.',
			listenerYaml: 'Listener YAML',
			listeners: 'Listeners',
			listeners_1fzojr3: 'listeners ·',
			...
			llmPolicies: 'LLM Policies',
			llmProviders: 'LLM Providers',
			llmRequestFields: 'LLM request fields',
			llmRequestModelStripPrefixAnthropic: 'llmRequest.model.stripPrefix("anthropic/")',
			loadingAnalytics: 'Loading analytics...',
			loadingEditor: 'Loading editor...',
			loadingGatewayConfiguration: 'Loading gateway configuration',
			loadingGateways: 'Loading gateways',
			loadingGuardrails: 'Loading guardrails',
			loadingKeys: 'Loading keys',
			loadingLogPayload: 'Loading log payload',
			loadingMcpServers: 'Loading MCP servers',
			loadingModelCatalog: 'Loading model catalog...',
			loadingModels: 'Loading models',
			loadingProviders: 'Loading providers',
			loadingRawConfiguration: 'Loading raw configuration...',
			loadingRuntimePolicies: 'Loading runtime policies',
			loadingRuntimeTrafficConfiguration: 'Loading runtime traffic configuration',
			loadingTrafficListeners: 'Loading traffic listeners',
			loadingTrafficRoutes: 'Loading traffic routes',
			localFile: 'Local file',
			localRateLimit: 'Local rate limit',
			localRateLimitsForIncomingRequests: 'Local rate limits for incoming requests.',
			...
			logSettings_12oqjpq: 'Log settings',
			logs: 'Logs',
			logsApiError: 'Logs API error',
			...
			managed: 'Managed',
			managedOnGuardrails: 'Managed on Guardrails',
			managedOnVirtualApiKeys: 'Managed on Virtual API Keys',
			...
			maskMatchedText: 'Mask matched text',
			match: 'Match',
			matchAndOptionallyMaskCustomRegularExpressions:
				'Match and optionally mask custom regular expressions.',
			matchConditionsAndModelSpecificPolicies: 'Match conditions and model-specific policies',
			...
			maxAge: 'Max age',
			maxRequestBytes: 'Max request bytes',
			maxTokens: 'Max tokens',
			maximumBodySizeToBufferInBytes: 'Maximum body size to buffer in bytes.',
			maximumHttp2FrameSize: 'Maximum HTTP/2 frame size.',
			...
			maximumSizeOfHttp2RequestHeaders: 'Maximum size of HTTP/2 request headers.',
			...
			maximumTimeAllowedForABackendHttpRequest: 'Maximum time allowed for a backend HTTP request.',
			...
			mcpBehavior: 'MCP behavior',
			mcpBrowserAccessIsNotAllowed: 'MCP browser access is not allowed',
			...
			mcpToolOutput: 'MCP tool output',
			mcpGateway: 'mcp://gateway',
			measure: 'Measure',
			menuAppearsInTheMenuBar: 'menu appears in the menu bar.',
			...
			metadataContextYaml: 'Metadata context YAML',
			metadataValuesToAddUsingCelExpressions: 'Metadata values to add using CEL expressions.',
			...
			method: 'Method',
			methodPhases: 'Method phases',
			microsoftEntra: 'Microsoft Entra',
			migrateBindsToGateways: 'Migrate binds to gateways',
			...
			minimumTokens: 'Minimum tokens',
			mode: 'mode.',
			model: 'Model',
			modelCelExpression: 'Model CEL expression',
			...
			modelsKeysPoliciesAndChatTesting: 'Models, keys, policies, and chat testing.',
			...
			modifyRequestHeadersBeforeForwarding: 'Modify request headers before forwarding.',
			...
			nameIsThePublicModelNameClientsRequest: 'name is the public model name clients request.',
			namespace: 'Namespace',
			namespaceKeyCelExpression: 'namespace: key: CEL expression',
			never: 'Never',
			...
			newKey: 'New key',
			noValueTransformationsConfigured: 'No {{value}} transformations configured.',
			noAdditionalMatchConditions: 'No additional match conditions.',
			noAnalyticsInTheSelectedWindow: 'No analytics in the selected window.',
			noAdditionalScopesConfigured: 'No additional scopes configured.',
			noArgs: 'no args',
			noAuthorizationRules: 'No authorization rules',
			noAudienceRestrictionConfigured: 'No audience restriction configured.',
			noBackendsConfigured: 'No backends configured.',
			...
			noCostCatalogsConfigured: 'No cost catalogs configured',
			noCustomCosts: 'No custom costs.',
			noGatewaySurfacesEnabledYet: 'No gateway surfaces enabled yet',
			noGatewaysConfigured: 'No gateways configured',
			noGuardsConfigured: 'No guards configured.',
			noHealthPolicyConfigured: 'No health policy configured',
			noHeaderConditions: 'No header conditions.',
			noHostConfigured: 'No host configured',
			noLegacyBindsConfigured: 'No legacy binds configured',
			...
			noListenersOnThisBind: 'No listeners on this bind',
			noLlmCallsMatchTheCurrentFilters: 'No LLM calls match the current filters.',
			noMatches: 'No matches',
			noMcpGuardrailProcessors: 'No MCP guardrail processors',
			noMcpMethodsConfigured: 'No MCP methods configured.',
			noMcpServers: 'No MCP servers',
			noMcpServersConfigured: 'No MCP servers configured',
			noMcpToolsAreAvailableFromTheMcpGateway: 'No MCP tools are available from the MCP gateway.',
			noMessagesYet: 'No messages yet.',
			noModels: 'No models',
			noModelsConfigured: 'No models configured',
			noPolicyFields: 'No policy fields',
			noPoliciesConfigured: 'No policies configured',
			noPromptCachingConfigured: 'No prompt caching configured',
			noProviderCredentialConfigured: 'No provider credential configured.',
			noQueryConditions: 'No query conditions.',
			noResponseYet: 'No response yet',
			noSystemPrompt: 'No system prompt',
			noRoutesArePresentInTheActiveGatewayDump: 'No routes are present in the active gateway dump.',
			noRuntimeListeners: 'No runtime listeners',
			noRuntimeRoutes: 'No runtime routes',
			noRuntimeTrafficConfiguration: 'No runtime traffic configuration',
			...
			noSharedProvidersConfigured: 'No shared providers configured',
			noToolsReturned: 'No tools returned',
			noTopLevelPolicies: 'No top-level policies',
			noTopLevelPoliciesArePresentInTheActiveGatewayDump:
				'No top-level policies are present in the active gateway dump.',
			noTrafficGatewaysConfigured: 'No traffic gateways configured',
			noTrafficRoutesConfigured: 'No traffic routes configured',
			noValuesConfigured: 'No values configured.',
			noValuesFound: 'No values found.',
			noVirtualApiKeys: 'No virtual API keys',
			none: 'none',
			none_deku7v: 'None',
			noneAdminInterfaceOnly: 'None (admin interface only)',
			...
			openClaudeDesktopAndEnableDeveloperMode: 'Open Claude Desktop and enable developer mode:',
			openInPlayground: 'Open in playground',
			openAiEmbeddings: 'OpenAI /embeddings',
			openAiRealtimeWebsockets: 'OpenAI /realtime (websockets)',
			...
			optionalOauthClientId: 'optional OAuth client ID',
			...
			optional06DefaultIs2: 'Optional. 0-6; default is 2.',
			optionalDefaultsToHttpLocalhost11434V1: 'Optional. Defaults to http://localhost:11434/v1.',
			optionalDefaultsToOmniModerationLatest: 'Optional. Defaults to omni-moderation-latest.',
			optionalDefaultsToUsCentral1: 'Optional. Defaults to us-central1.',
			optionalIfUnsetVertexUsesGlobal: 'Optional. If unset, Vertex uses global.',
			optionalLeaveUnsetToUseTheGatewayDefault: 'Optional. Leave unset to use the gateway default.',
			...
			other: 'Other',
			otlpHttpPathUsedToExportLogs: 'OTLP HTTP path used to export logs.',
			otlpHttpPathUsedToExportTraces: 'OTLP HTTP path used to export traces.',
			otlpLogExportSettings: 'OTLP log export settings.',
			otlpPathDefaultIsV1Traces: 'OTLP path. Default is /v1/traces',
			otlpProtocolUsedToExportLogs: 'OTLP protocol used to export logs.',
			...
			output: 'Output',
			overrideOpenAiBaseUrl: 'Override OpenAI Base URL',
			overrideRequestValues: 'Override request values',
			overrideTheDefaultBasePathPrefixForThisProvider:
				'Override the default base path prefix for this provider.',
			overrideTheUpstreamHostForThisProvider: 'Override the upstream host for this provider.',
			overrideTheUpstreamPathForThisProvider: 'Override the upstream path for this provider.',
			overrideWhereThisPolicyReadsTheJwtFrom: 'Override where this policy reads the JWT from.',
			...
			pasteAJwksDocumentDirectlyIntoThePolicy: 'Paste a JWKS document directly into the policy.',
			path: 'Path',
			...
			pathRewriteToApplyToTheRedirectUrl: 'Path rewrite to apply to the redirect URL.',
			pemEncodedPrivateSigningKeyRsaOrEcMatchingAlg:
				'PEM-encoded private signing key (RSA or EC, matching `alg`).',
			permissive: 'Permissive',
			permitBrowserCredentialsOnCorsRequests: 'Permit browser credentials on CORS requests',
			permitMatchingRequests: 'Permit matching requests.',
			phone: 'Phone',
			...
			pointThePythonSdkAtTheGatewayListener: 'Point the Python SDK at the gateway listener.',
			policies: 'policies',
			policies_raqot3: 'Policies',
			...
			policyModeIsValue: 'Policy mode is {{value}}',
			priority_one: '{{count}} priority',
			priority_other: '{{count}} priorities',
			...
			policySettingsToApplyToTheSelectedTarget: 'Policy settings to apply to the selected target.',
			...
			portIsThePortToListenOnForThisGateway: 'port is the port to listen on for this gateway.',
			...
			prefixForwardingTheRemainingModelAsIs: 'prefix, forwarding the remaining model as-is.',
			...
			primary: 'Primary',
			primaryDatabaseUsedByLocalRuntimeFeatures: 'Primary database used by local runtime features.',
			priorityGroupsTargetsForFailoverLowerValuesArePreferred:
				'priority groups targets for failover. Lower values are preferred.',
			privateKeyFileForTheClientCertificate: 'Private key file for the client certificate.',
			processingBehavior: 'Processing behavior',
			processor: 'Processor',
			...
			promptLoggingIsOff: 'Prompt logging is off',
			...
			providerOfTheLlmWeAreConnectingTo: 'provider of the LLM we are connecting to.',
			providerOfTheLlmWeAreConnectingToo: 'provider of the LLM we are connecting too',
			providerReturned: 'Provider returned',
			provider_1k5qy2a: 'provider:',
			providers: 'Providers',
			...
			proxyBackendUsedToTunnelTheConnection: 'Proxy backend used to tunnel the connection.',
			...
			publicUiGateway: 'Public UI gateway',
			query: 'Query',
			...
			queryParameterNameContainingTheCredential: 'Query parameter name containing the credential.',
			queryValue: 'Query value',
			quickRanges: 'Quick ranges',
			rateLimitDomainSentToTheRemoteRateLimitService:
				'Rate limit domain sent to the remote rate limit service.',
			rawApiKey: 'Raw API key',
			rawConfiguration: 'Raw Configuration',
			rawConfigurationDiff: 'Raw configuration diff',
			rawGuardYaml: 'Raw guard YAML',
			rawJson: 'Raw JSON',
			rawLogJson: 'Raw log JSON',
			rawValue: 'Raw value',
			...
			readTheCredentialFromARequestCookie: 'Read the credential from a request cookie.',
			readTheCredentialFromAUrlQueryParameter: 'Read the credential from a URL query parameter.',
			readTheCredentialFromAnHttpHeader: 'Read the credential from an HTTP header.',
			...
			redirectExpression: 'Redirect expression',
			redirectUri: 'Redirect URI',
			reference: 'reference',
			refresh: 'Refresh',
			refreshBaseCosts: 'Refresh base costs',
			refreshTheBaseCatalogToAddPricingDataFromModelsDev:
				'Refresh the base catalog to add pricing data from models.dev.',
			refreshing: 'Refreshing...',
			regex: 'Regex',
			regexOrBuiltInPatternsToEvaluate: 'Regex or built-in patterns to evaluate.',
			regularExpressionPatternToEvaluate: 'Regular expression pattern to evaluate.',
			rejectHttpConnectRequests: 'Reject HTTP CONNECT requests.',
			rejectMatchingRequests: 'Reject matching requests.',
			rejectRequest: 'Reject request',
			rejectRequestsThatDoNotCarryAValidToken: 'Reject requests that do not carry a valid token.',
			rejectTheRequestOrResponseWhenContentMatches:
				'Reject the request or response when content matches.',
			rejectTheRequestWhenADetectorMatches: 'Reject the request when a detector matches.',
			rejectTheRequestWhenARegexMatches: 'Reject the request when a regex matches.',
			...
			rejectWhenTheProcessorIsUnavailable: 'Reject when the processor is unavailable.',
			...
			remoteRateLimit: 'Remote rate limit',
			remoteRateLimitChecksForIncomingRequests: 'Remote rate limit checks for incoming requests.',
			...
			removeAllLlmGuardrails: 'Remove all LLM guardrails?',
			removeAllRequestAndResponseGuardrailsLlmTrafficWillNoLongerBeCheckedByTheseRules:
				'Remove all request and response guardrails? LLM traffic will no longer be checked by these rules.',
			removeBackend: 'Remove backend',
			removeConditionalTarget: 'Remove conditional target',
			removeCustomCost: 'Remove custom cost',
			removeDescriptor: 'Remove descriptor',
			removeDescriptorEntry: 'Remove descriptor entry',
			removeFailoverGroupValue: 'Remove failover group {{value}}',
			removeGuardrail: 'Remove guardrail',
			removeGuardrail_1r9af69: 'Remove guardrail?',
			...
			replaceMatchedContentAndContinue: 'Replace matched content and continue.',
			replaceMatchingContentWithMaskedText: 'Replace matching content with masked text.',
			replaceOnlyTheHostAndPreserveTheEffectivePort:
				'Replace only the host and preserve the effective port.',
			replaceOnlyTheMatchedPathPrefix: 'Replace only the matched path prefix.',
			replaceOnlyThePort: 'Replace only the port.',
			replaceTheFullAuthorityIncludingHostAndOptionalPort:
				'Replace the full authority, including host and optional port.',
			replaceTheFullRequestPath: 'Replace the full request path.',
			request: 'request',
			request_1058hua: 'Request',
			...
			requestContextYaml: 'Request context YAML',
			...
			requestLogIdentity: 'Request log identity',
			...
			requestTransformations: 'Request transformations',
			...
			requireAValidApiKey: 'Require a valid API key.',
			requireAValidJwtFromAConfiguredIssuer: 'Require a valid JWT from a configured issuer.',
			requireAValidUsernameAndPassword: 'Require a valid username and password.',
			...
			requireThisCelExpressionToBeTrue: 'Require this CEL expression to be true.',
			requireThisExpressionToBeTrue: 'Require this expression to be true.',
			...
			resourceMetadataYaml: 'Resource metadata YAML',
			response: 'response',
			response_nrnldq: 'Response',
			responseAttributes: 'Response attributes',
			responseBody: 'Response body',
			responseBodyReturnedWhenContentIsRejected: 'Response body returned when content is rejected.',
			...
			responseGuards: 'Response guards',
			responseHeaders: 'Response headers',
			responseHeadersComputedFromCelExpressions: 'Response headers computed from CEL expressions.',
			responseReturnedWhenTheLlmResponseIsRejected:
				'Response returned when the LLM response is rejected.',
			responseReturnedWhenTheRequestIsRejected: 'Response returned when the request is rejected.',
			responseTrailers: 'Response trailers',
			responseTransformations: 'Response transformations',
			...
			result: 'Result',
			resultingYaml: 'Resulting YAML',
			retryMatchingFailedUpstreamRequests: 'Retry matching failed upstream requests.',
			...
			routeProtocolFamily: 'Route protocol family.',
			...
			routes: 'routes',
			routes_14u6307: 'Routes',
			routes_4p3286: 'routes ·',
			...
			rule: 'Rule',
			run: 'Run',
			runAfterTheMcpResponseIsAvailable: 'Run after the MCP response is available.',
			runBeforeForwardingTheMcpRequest: 'Run before forwarding the MCP request.',
			runWithRequestAndResponseContext: 'Run with request and response context.',
			runtimeTraffic: 'Runtime traffic',
			safety: 'Safety',
			save: 'Save',
			saveFailed: 'Save failed',
			savePolicy: 'Save policy',
			saveUiGateway: 'Save UI gateway',
			schemeToUseInTheRedirectUrlSuchAsHttpOrHttps:
				'Scheme to use in the redirect URL, such as `http` or `https`.',
			scopes: 'Scopes',
			sdkSnippetsUseThisUrlWithV1Appended: 'SDK snippets use this URL with /v1 appended.',
			searchValue: 'Search {{value}}',
			searchFor: 'Search for',
			secretValueToSendToTheBackend: 'Secret value to send to the backend.',
			security: 'Security',
			selectAConcreteModel: 'Select a concrete model',
			selectAGateway: 'Select a gateway.',
			selectAListener: 'Select a listener.',
			selectGuardType: 'Select guard type',
			selectOrTypeAModel: 'Select or type a model',
			...
			send: 'Send',
			sendABoundedBodyBufferAndAllowTruncation: 'Send a bounded body buffer and allow truncation.',
			...
			sendThisPhaseToTheExternalProcessor: 'Send this phase to the external processor.',
			sendTrailersToTheExternalProcessingService:
				'Send trailers to the external processing service.',
			sending: 'Sending',
			sendingChatCompletion: 'Sending chat completion',
			sendingToolResults: 'Sending tool results',
			serverName: 'Server name',
			serverNameToUseForTlsVerificationAndSni: 'Server name to use for TLS verification and SNI.',
			servers: 'Servers',
			serversToolsAndMcpPlaygroundFlows: 'Servers, tools, and MCP playground flows.',
			service: 'Service',
			...
			setUpServers: 'Set up servers',
			settings: 'Settings',
			settingsForExportingRequestTraces: 'Settings for exporting request traces.',
			settingsForHandlingIncomingHttpRequests: 'Settings for handling incoming HTTP requests.',
			settingsForHandlingIncomingTcpConnections: 'Settings for handling incoming TCP connections.',
			settingsForHandlingIncomingTlsConnections: 'Settings for handling incoming TLS connections.',
			settingsForRequestAccessLogs: 'Settings for request access logs.',
			...
			shaping: 'Shaping',
			show: 'Show',
			showValueOptions: 'Show {{value}} options',
			showFullKey: 'Show full key',
			signBackendRequestsWithAwsCredentials: 'Sign backend requests with AWS credentials.',
			...
			someListenersMixHttpAndTcpRoutes: 'Some listeners mix HTTP and TCP routes',
			source: 'Source',
			sourcesAreMergedInOrderLaterSourcesOverrideEarlierEntries:
				'Sources are merged in order. Later sources override earlier entries.',
			spanAttributesToAddKeyedByAttributeName: 'Span attributes to add, keyed by attribute name.',
			...
			staticResponseBodyEncodedAsBytes: 'Static response body, encoded as bytes.',
			staticTagValue: 'Static tag value.',
			...
			target_other: '{{count}} targets',
			targetModel: 'Target model',
			targetType: 'Target type',
			targetTheVisualEditorCurrentlySupportsHostTargetsOnly:
				'target. The visual editor currently supports host targets only.',
			targets: 'Targets',
			...
			tcpKeepaliveSettingsForBackendConnections: 'TCP keepalive settings for backend connections.',
			tcpKeepaliveSettingsForDownstreamConnections:
				'TCP keepalive settings for downstream connections.',
			tcpProtocolSettingsForThisBackend: 'TCP protocol settings for this backend.',
			...
			theGcpProjectId: 'The GCP project ID',
			theGcpRegionDefaultUsCentral1: 'The GCP region (default: us-central1)',
			...
			theTemplateIdForTheModelArmorConfiguration:
				'The template ID for the Model Armor configuration',
			theTypeOfAzureEndpointToConnectTo: 'The type of Azure endpoint to connect to.',
			theTypeOfAzureEndpointDeterminesTheHostSuffix:
				'The type of Azure endpoint. Determines the host suffix.',
			theUniqueIdentifierOfTheGuardrail: 'The unique identifier of the guardrail',
			...
			theVersionOfTheGuardrail: 'The version of the guardrail',
			thisCannotBeUndone_1x7m3fy: 'This cannot be undone.',
			thisConfigurationUsesLegacy: 'This configuration uses legacy',
			...
			thisPolicyUsesA: 'This policy uses a',
			...
			thisToolDoesNotDeclareArguments: 'This tool does not declare arguments.',
			timeToWaitForAnHttp2KeepalivePingResponse:
				'Time to wait for an HTTP/2 keepalive ping response.',
			timingAndUsage: 'Timing and usage',
			...
			tlsEnablesHttpsForThisListener: 'tls enables HTTPS for this listener.',
			...
			to: 'To',
			toCaptureRequestAndResponsePayloads: 'to capture request and response payloads.',
			toTheLlmCorsPolicySoThisPlaygroundCanCallTheGatewayFromTheBrowser:
				'to the LLM CORS policy so this playground can call the gateway from the browser.',
			toTheMcpCorsPolicyAndExposeMcpSessionIdSoThisPlaygroundCanKeepABrowserSession:
				'to the MCP CORS policy and expose Mcp-Session-Id so this playground can keep a browser session.',
			toTheMcpCorsPolicySoThePlaygroundCanListAndCallMcpToolsFromTheBrowser:
				'to the MCP CORS policy so the playground can list and call MCP tools from the browser.',
			toggleTheme: 'Toggle theme',
			tokenEndpoint: 'Token endpoint',
			tokenEndpointAuth: 'Token endpoint auth',
			...
			toolsCallPromptsOr: 'tools/call, prompts/*, or *',
			...
			topLevelConfigurationSectionAlreadyExists:
			...
			traffic: 'Traffic',
			trafficGateways: 'Traffic Gateways',
			trafficListeners: 'Traffic Listeners',
			trafficOverTime: 'Traffic over time',
			trafficRoutes: 'Traffic Routes',
			trafficBindDeleteWithListeners_one: 'This also removes {{count}} listener and its routes.',
			trafficBindDeleteWithListeners_other:
				'This also removes {{count}} listeners and their routes.',
			trafficDeleteWarning: 'Traffic using {{value}} will no longer be served.',
			...
			transformTheRequestBeforeItIsForwarded: 'Transform the request before it is forwarded.',
			transformTheResponseBeforeItIsReturned: 'Transform the response before it is returned.',
			...
			transport: 'Transport',
			treatHttpConnectRequestsAsTunnels: 'Treat HTTP CONNECT requests as tunnels.',
			...
			trustedIssuersAndTheirSigningKeys: 'Trusted issuers and their signing keys.',
			...
			type: 'Type',
			uSSocialSecurityNumberPattern: 'U.S. Social Security number pattern.',
			uiAccessPolicies: 'UI access policies',
			...
			uiIsExposedWithoutAuthentication: 'UI is exposed without authentication',
			...
			unset: 'Unset',
			unsupportedBackendShapeInThisForm: 'Unsupported backend shape in this form',
			unsupportedGuard: 'Unsupported guard',
			unsupportedGuardShape: 'Unsupported guard shape',
			unsupportedRateLimitShape: 'Unsupported rate limit shape',
			unsupportedRemoteRateLimitShape: 'Unsupported remote rate limit shape',
			unsupportedTargetType: 'Unsupported target type',
			unused: 'unused',
			upstreamApiShapeThisCustomProviderSaysItAccepts:
				'Upstream API shape this custom provider says it accepts.',
			upstreamModel: 'Upstream model',
			url: 'URL',
			useABuiltInSensitiveDataPattern: 'Use a built-in sensitive data pattern.',
			useACustomRegularExpression: 'Use a custom regular expression.',
			...
			useAwsBedrockGuardrails: 'Use AWS Bedrock Guardrails.',
			useAzureAiContentSafety: 'Use Azure AI Content Safety.',
			useAzureContentSafetyToEvaluateThePrompt: 'Use Azure Content Safety to evaluate the prompt.',
			...
			useEnvoyExternalAuthorizationOverGRpc: 'Use Envoy external authorization over gRPC.',
			useExplicitAwsCredentials: 'Use explicit AWS credentials',
			useExplicitAzureCredentials: 'Use explicit Azure credentials',
			useGoogleModelArmorForSafetyChecks: 'Use Google Model Armor for safety checks.',
			useGoogleModelArmorToEvaluateThePrompt: 'Use Google Model Armor to evaluate the prompt.',
			useGoogleModelArmorToEvaluateTheResponse: 'Use Google Model Armor to evaluate the response.',
			...
			useOpenAiModerationToEvaluateThePrompt: 'Use OpenAI moderation to evaluate the prompt.',
			...
			useStrictModeWhenKeysShouldBeMandatory: 'Use strict mode when keys should be mandatory.',
			...
			useTheSelectedBackendHostWhenPossible: 'Use the selected backend host when possible.',
			useThisWhenTheUpstreamExposesOneOrMoreLlmCompatibleHttpApisAtYourOwnEndpoint:
				'Use this when the upstream exposes one or more LLM-compatible HTTP APIs at your own endpoint.',
			...
			user_19x0vko: 'user:',
			users: 'Users',
			validateATokenWhenOneIsPresent: 'Validate a token when one is present.',
			...
			validationModeForApiKeyAuthentication: 'Validation mode for API key authentication.',
			validationModeForBasicAuth: 'Validation mode for Basic Auth.',
			...
			waitingForFinalResponse: 'Waiting for final response',
			waitingForModelResponse: 'Waiting for model response',
			warnings: 'warnings',
			warnings_1j8s2pg: 'Warnings',
			webhook: 'Webhook',
			...
			weightedTargets: 'Weighted targets',
			welcomeToAgentgateway: 'Welcome to Agentgateway',
			...
			whereToPlaceTheSecretInTheBackendRequest: 'Where to place the secret in the backend request.',
			...
			whereToReadTheJwtFromInIncomingRequests: 'Where to read the JWT from in incoming requests.',
			...
			whichTrafficGatewayExposesTheUi: 'Which traffic gateway exposes the UI.',
			...
			x: 'x',
			yamlValueReturnedByCelEvaluation: 'YAML value returned by CEL evaluation.',
			...
			alwaysPrefixNamesEvenWithASingleTarget: 'Always prefix names, even with a single target.',
			...
			awsRegionForTheBedrockEndpoint: 'AWS region for the Bedrock endpoint.',
			awsRegionToUseForTheBedrockProvider: 'AWS region to use for the Bedrock provider.',
			...
			basePricingRatesForThisModel: 'Base pricing rates for this model.',
			...
			costPer1MInputPromptTokens: 'Cost per 1M input (prompt) tokens.',
			...
			costPer1MOutputCompletionTokens: 'Cost per 1M output (completion) tokens.',
			...
			costPer1MTokensReadFromCache: 'Cost per 1M tokens read from cache.',
			costPer1MTokensWrittenToCache: 'Cost per 1M tokens written to cache.',
			customFieldsToAddToAllMetrics: 'Custom fields to add to all metrics.',
			...
			distributedTracingConfiguration: 'Distributed tracing configuration.',
			...
			fieldNamesToRemoveFromLogEntries: 'Field names to remove from log entries.',
			gatewayLevelPoliciesAppliedToAllTrafficOnThisListener:
				'Gateway-level policies applied to all traffic on this listener.',
			googleCloudProjectIdForVertexAi: 'Google Cloud project ID for Vertex AI.',
			...
			hostnameOrIpAddressOfTheMcpServer: 'Hostname or IP address of the MCP server.',
			...
			httpRoutesAttachedDirectlyToThisListener: 'HTTP routes attached directly to this listener.',
			...
			identifierOfTheBedrockGuardrailToApply: 'Identifier of the Bedrock guardrail to apply.',
			idleTimeBeforeTheFirstKeepaliveProbeIsSent:
				'Idle time before the first keepalive probe is sent.',
			kubernetesNamespaceForThisGatewayInstance: 'Kubernetes namespace for this gateway instance.',
			...
			logOutputFormatTextOrJson: 'Log output format: `text` or `json`.',
			...
			mapOfModelIdToItsPricingRatesAndTiers: 'Map of model ID to its pricing rates and tiers.',
			...
			mcpServerTargetsToMultiplexTogether: 'MCP server targets to multiplex together.',
			messageRoleSuchAsSystemUserOrAssistant:
				'Message role, such as "system", "user", or "assistant".',
			messageTextContent: 'Message text content.',
			metricNamesToExcludeFromCollection: 'Metric names to exclude from collection.',
			...
			modelCostCatalogProvidedInlineAsAString: 'Model cost catalog provided inline as a string.',
			...
			nameIdentifyingThisResource: 'Name identifying this resource.',
			nameIdentifyingThisRoute: 'Name identifying this route.',
			nameOfTheGatewayThisTargetReferences: 'Name of the gateway this target references.',
			nameOfTheListenerSetResource: 'Name of the listener set resource.',
			...
			namespaceOfTheGatewayThisTargetReferences: 'Namespace of the gateway this target references.',
			namespaceOfTheListenerSetResource: 'Namespace of the listener set resource.',
			namespaceScopingThisListener: 'Namespace scoping this listener.',
			...
			namespaceScopingThisRoute: 'Namespace scoping this route.',
			...
			otlpTransportProtocolGrpcOrHttp: 'OTLP transport protocol: `grpc` or `http`.',
			...
			pathToAFileOnDiskToLoadTheValueFrom: 'Path to a file on disk to load the value from.',
			...
			pathToTheTlsPrivateKeyFile: 'Path to the TLS private key file.',
			policiesAppliedToMcpRequests: 'Policies applied to MCP requests.',
			policiesAppliedToThisMcpTarget: 'Policies applied to this MCP target.',
			portOnTheMcpServerToConnectTo: 'Port on the MCP server to connect to.',
			portOnTheTargetServiceToRouteTo: 'Port on the target Service to route to.',
			...
			queryParameterNameToMatch: 'Query parameter name to match.',
			...
			requestPathOnTheMcpServer: 'Request path on the MCP server.',
			...
			resourceKindUsedInPolicyTargetReferences: 'Resource kind used in policy target references.',
			...
			specificRuleWithinThisRoute: 'Specific rule within this route.',
			spiffeTrustDomainForThisGateway: 'SPIFFE trust domain for this gateway.',
			staticSessionName: 'Static session name.',
			...
			tcpRoutesAttachedDirectlyToThisListener: 'TCP routes attached directly to this listener.',
			theUpstreamLlmProviderTypeAndItsConfiguration:
				'The upstream LLM provider type and its configuration.',
			timeBetweenSuccessiveKeepaliveProbes: 'Time between successive keepalive probes.',
			...
			versionOfTheBedrockGuardrailToApply: 'Version of the Bedrock guardrail to apply.',
			...
			jwsSigningAlgorithmDefaultsToRs256: 'JWS signing algorithm. Defaults to `RS256`.',
			...
			sendTheX509CertificateChainInX5c: 'Send the X.509 certificate chain in `x5c`.',
			...
			policiesToConnectToTheProxyBackend: 'Policies to connect to the proxy backend.',
			...
			policyForGeneratedOutputModeration: 'Policy for generated output moderation.',
			...
			expectedIssuerClaimForAcceptedJwts: 'Expected issuer claim for accepted JWTs.',
			...
			claudeDesktopOpenDeveloperMenu: 'Open Developer > Configure third-party inference > Gateway.',
			...
			cursorOverrideBaseUrlInstruction: 'Enable Override OpenAI Base URL and set it to {{value}}.',
			cursorAddModelInstruction:
				'Add {{value}} as a custom model, then test it in Ask or Plan mode.',
			copilotOpenSettingsInstruction: 'Open VS Code Settings and search for {{value}}.',
			copilotEditSettingsInstruction: 'Edit {{value}} and set the advanced proxy URL.',
			windsurfOpenSettingsInstruction: 'Open Windsurf Settings.',
			windsurfSetProxyInstruction: 'Set the HTTP proxy URL to {{value}} and save.',
			legacyBindsWarning:
			...
			deleteTargetQuestion: 'Delete {{value}}? Traffic can no longer be sent to this target.',
			deleteRouteQuestion:
			...
			modelPatternCanContainAtMostOneWildcard: 'A model pattern can contain at most one wildcard.',
			...
			noBudgetsConfiguredUsageIsUnlimited: 'No budgets configured. Usage is unlimited.',
			...
			cannotBeCombinedWithOtherModelPatterns: "'*' cannot be combined with other model patterns.",
			wildcardsAreOnlySupportedAtTheBeginningOrEndOfAPattern:
				'Wildcards are only supported at the beginning or end of a pattern.',
			aModelPatternCanContainAtMostOneWildcard: 'A model pattern can contain at most one wildcard.',
			...
			noUsageRecordedYetValueRollingWindow: 'No usage recorded yet · {{value}} rolling window',
			valueOfValuePerValue: '{{value}} of {{value}} per {{value}}',
			portConflict: 'Port conflict',
			conflict: 'Conflict',
			valueListenersInvolvedInPortConflicts: '{{value}} listeners involved in port conflicts',
			...
			geminiChatModelsModelGenerateContent: 'Gemini chat (models/{model}:generateContent)',
			geminiTokenCountModelsModelCountTokens: 'Gemini token count (models/{model}:countTokens)',
			chatCompletionsFormat: 'Chat completions (/v1/chat/completions)',
			anthropicMessagesFormat: 'Anthropic messages (/v1/messages)',
			responsesFormat: 'Responses (/v1/responses)',
			embeddingsFormat: 'Embeddings (/v1/embeddings)',
			anthropicTokenCountFormat: 'Anthropic token count (/v1/messages/count_tokens)',
			realtimeFormat: 'Realtime (/v1/realtime)',
			rerankFormat: 'Rerank (/v2/rerank)',
			bedrockGuardrailDetailsNotSet: 'Bedrock guardrail details not set.',
			defaultModerationModel: 'Default moderation model.',
			guardBuiltInSummary_one: '{{value}} {{value}} built-in detector.',
			guardBuiltInSummary_other: '{{value}} {{value}} built-in detectors.',
			guardEndpointOnlySummary: '{{value}}.',
			guardEndpointSummary: '{{value}} · {{value}}.',
			guardModelSummary: 'Model {{value}}.',
			guardRegexSummary_one: '{{value}} {{value}} regex pattern.',
			guardRegexSummary_other: '{{value}} {{value}} regex patterns.',
			guardTargetSummary: '{{value}} · {{value}}.',
			jailbreakDetection: 'jailbreak detection',
			mask: 'Mask',
			modelArmorDetailsNotSet: 'Model Armor details not set.',
			rawGuardYamlPreserved:
				'Raw guard YAML is preserved. Use Raw Configuration for unsupported edits.',
			reject: 'Reject',
			summaryWithRejection: '{{value}} Rejects with {{value}}.',
			webhookTargetNotSet: 'Webhook target not set.',
			azureEndpointNotSet: 'Azure endpoint not set.',
			...
			freeformCapabilityRoutingTagsForThisModel: 'Freeform capability/routing tags for this model.',
			...
			whichPartsOfTheRequestThisGuardInspects: 'Which parts of the request this guard inspects.',
