...
pub trait CELListener<'input>: ParseTreeListener<'input, CELParserContextType> {
	...
	/**
	 * Enter a parse tree produced by {@link CELParser#matchArmList}.
	 * @param ctx the parse tree
	 */
	fn enter_matchArmList(&mut self, _ctx: &MatchArmListContext<'input>) {}
	/**
	 * Exit a parse tree produced by {@link CELParser#matchArmList}.
	 * @param ctx the parse tree
	 */
	fn exit_matchArmList(&mut self, _ctx: &MatchArmListContext<'input>) {}
	/**
	 * Enter a parse tree produced by {@link CELParser#matchArm}.
	 * @param ctx the parse tree
	 */
	fn enter_matchArm(&mut self, _ctx: &MatchArmContext<'input>) {}
	/**
	 * Exit a parse tree produced by {@link CELParser#matchArm}.
	 * @param ctx the parse tree
	 */
	fn exit_matchArm(&mut self, _ctx: &MatchArmContext<'input>) {}
	/**
