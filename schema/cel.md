...
|`source.rawAddress`|string|The original TCP peer IP address of the downstream connection.|
|`source.rawPort`|integer|The original TCP peer port of the downstream connection.|
